...
genline: KOC_opcode  expr {
   genlocrec(currseg, labelloc);
   pevalexpr(1, $2);
   locctr += geninstr(findgen($1, ST_DIR1, cpuselect + ((evalr[1].seg == SSG_ABS && evalr[1].value >= 0 && evalr[1].value <= 255)
            ? DIRECT : EXTENDED)));
}
;
genline: KOC_opcode  expr ',' expr {
   ...
   pevalexpr(1, $2);
   pevalexpr(2, $4);
   locctr += geninstr(findgen($1, ST_DIR2, cpuselect + ((evalr[2].seg == SSG_ABS && evalr[2].value >= 0 && evalr[2].value <= 255)
            ? DIRECT : EXTENDED)));
}
;
genline: KOC_opcode  expr ',' expr ',' expr {
   ...
   pevalexpr(2, $4);
   pevalexpr(3, $6);
   locctr += geninstr(findgen($1, ST_DIR3, cpuselect + ((evalr[3].seg == SSG_ABS && evalr[3].value >= 0 && evalr[3].value <= 255)
            ? DIRECT : EXTENDED)));
}
;
genline: KOC_opcode  '#' expr {
...
genline: KOC_opcode  expr '[' expr ']' {
   ...
   pevalexpr(1, $2);
   pevalexpr(2, $4);
   locctr += geninstr(findgen($1, ST_INX1, cpuselect + ((evalr[1].seg == SSG_ABS && evalr[1].value >= -128 && evalr[1].value <= 127)
            ? DIRECT : EXTENDED)));
}
;
genline: KOC_opcode  expr ',' expr '[' expr ']' {
   ...
   pevalexpr(2, $4);
   pevalexpr(3, $6);
   locctr += geninstr(findgen($1, ST_INX2, cpuselect + ((evalr[2].seg == SSG_ABS && evalr[2].value >= -128 && evalr[2].value <= 127)
            ? DIRECT : EXTENDED)));
}
;
genline: KOC_opcode  expr ',' expr ',' expr '[' expr ']' {
   ...
   pevalexpr(3, $6);
   pevalexpr(4, $8);
   locctr += geninstr(findgen($1, ST_INX3, cpuselect + ((evalr[3].seg == SSG_ABS && evalr[3].value >= -128 && evalr[3].value <= 127)
            ? DIRECT : EXTENDED)));
}
;
