...
line: KOC_CPU STRING {
   if (!cpumatch($2)) fraerror("unknown cpu type, 68hc11 assumed"), cpuselect = CPU6811;
};
...
bool cpumatch(char *str) {
   static struct {
      ...
      {"11", CPU6811}, {"01", CPU6801}, {"00", CPU6800}, {"03", CPU6801},
      {"02", CPU6800}, {"08", CPU6800}
   };
...
struct opsym optab[] = {
   {"invalid", KOC_opcode, 2, 0}, {"ABA", KOC_opcode, 1, 2}, {"ABX", KOC_opcode, 1, 3}, {"ABY", KOC_opcode, 1, 4},
   {"ADC", KOC_opcode, 3, 5}, {"ADCA", KOC_opcode, 3, 8}, {"ADCB", KOC_opcode, 3, 11}, {"ADD", KOC_opcode, 3, 14},
   {"ADDA", KOC_opcode, 3, 17}, {"ADDB", KOC_opcode, 3, 20}, {"ADDD", KOC_opcode, 3, 23}, {"AND", KOC_opcode, 3, 26},
   {"ANDA", KOC_opcode, 3, 29}, {"ANDB", KOC_opcode, 3, 32}, {"ASL", KOC_opcode, 3, 35}, {"ASLA", KOC_opcode, 1, 38},
   {"ASLB", KOC_opcode, 1, 39}, {"ASLD", KOC_opcode, 1, 40}, {"ASR", KOC_opcode, 3, 41}, {"ASRA", KOC_opcode, 1, 44},
   {"ASRB", KOC_opcode, 1, 45}, {"BCC", KOC_opcode, 1, 46}, {"BCLR", KOC_opcode, 2, 47}, {"BCS", KOC_opcode, 1, 49},
   {"BEQ", KOC_opcode, 1, 50}, {"BGE", KOC_opcode, 1, 51}, {"BGT", KOC_opcode, 1, 52}, {"BHI", KOC_opcode, 1, 53},
   {"BHS", KOC_opcode, 1, 54}, {"BIT", KOC_opcode, 3, 55}, {"BITA", KOC_opcode, 3, 58}, {"BITB", KOC_opcode, 3, 61},
   {"BLE", KOC_opcode, 1, 64}, {"BLO", KOC_opcode, 1, 65}, {"BLS", KOC_opcode, 1, 66}, {"BLT", KOC_opcode, 1, 67},
   {"BMI", KOC_opcode, 1, 68}, {"BNE", KOC_opcode, 1, 69}, {"BPL", KOC_opcode, 1, 70}, {"BRA", KOC_opcode, 1, 71},
   {"BRCLR", KOC_opcode, 2, 72}, {"BRN", KOC_opcode, 1, 74}, {"BRSET", KOC_opcode, 2, 75}, {"BSET", KOC_opcode, 2, 77},
   {"BSR", KOC_opcode, 1, 79}, {"BVC", KOC_opcode, 1, 80}, {"BVS", KOC_opcode, 1, 81}, {"BYTE", KOC_BDEF, 0, 0},
   {"CBA", KOC_opcode, 1, 82}, {"CHARDEF", KOC_CHDEF, 0, 0}, {"CHARSET", KOC_CHSET, 0, 0}, {"CHARUSE", KOC_CHUSE, 0, 0},
   {"CHD", KOC_CHDEF, 0, 0}, {"CLC", KOC_opcode, 1, 83}, {"CLI", KOC_opcode, 1, 84}, {"CLR", KOC_opcode, 3, 85},
   {"CLRA", KOC_opcode, 1, 88}, {"CLRB", KOC_opcode, 1, 89}, {"CLV", KOC_opcode, 1, 90}, {"CMP", KOC_opcode, 3, 91},
   {"CMPA", KOC_opcode, 3, 94}, {"CMPB", KOC_opcode, 3, 97}, {"COM", KOC_opcode, 3, 100}, {"COMA", KOC_opcode, 1, 103},
   {"COMB", KOC_opcode, 1, 104}, {"CPD", KOC_opcode, 3, 105}, {"CPU", KOC_CPU, 0, 0}, {"CPX", KOC_opcode, 3, 108},
   {"CPY", KOC_opcode, 3, 111}, {"DAA", KOC_opcode, 1, 114}, {"DB", KOC_BDEF, 0, 0}, {"DEC", KOC_opcode, 3, 115},
   {"DECA", KOC_opcode, 1, 118}, {"DECB", KOC_opcode, 1, 119}, {"DES", KOC_opcode, 1, 120}, {"DEX", KOC_opcode, 1, 121},
   {"DEY", KOC_opcode, 1, 122}, {"DW", KOC_WDEF, 0, 0}, {"ELSE", KOC_ELSE, 0, 0}, {"END", KOC_END, 0, 0},
   {"ENDI", KOC_ENDI, 0, 0}, {"EOR", KOC_opcode, 3, 123}, {"EORA", KOC_opcode, 3, 126}, {"EORB", KOC_opcode, 3, 129},
   {"EQU", KOC_EQU, 0, 0}, {"FCB", KOC_BDEF, 0, 0}, {"FCC", KOC_SDEF, 0, 0}, {"FDB", KOC_WDEF, 0, 0},
   {"FDIV", KOC_opcode, 1, 132}, {"IDIV", KOC_opcode, 1, 133}, {"IF", KOC_IF, 0, 0}, {"INC", KOC_opcode, 3, 134},
   {"INCA", KOC_opcode, 1, 137}, {"INCB", KOC_opcode, 1, 138}, {"INCL", KOC_INCLUDE, 0, 0}, {"INCLUDE", KOC_INCLUDE, 0, 0},
   {"INS", KOC_opcode, 1, 139}, {"INX", KOC_opcode, 1, 140}, {"INY", KOC_opcode, 1, 141}, {"JMP", KOC_opcode, 2, 142},
   {"JSR", KOC_opcode, 2, 144}, {"LDA", KOC_opcode, 3, 146}, {"LDAA", KOC_opcode, 3, 149}, {"LDAB", KOC_opcode, 3, 152},
   {"LDD", KOC_opcode, 3, 155}, {"LDS", KOC_opcode, 3, 158}, {"LDX", KOC_opcode, 3, 161}, {"LDY", KOC_opcode, 3, 164},
   {"LSL", KOC_opcode, 3, 167}, {"LSLA", KOC_opcode, 1, 170}, {"LSLB", KOC_opcode, 1, 171}, {"LSLD", KOC_opcode, 1, 172},
   {"LSR", KOC_opcode, 3, 173}, {"LSRA", KOC_opcode, 1, 176}, {"LSRB", KOC_opcode, 1, 177}, {"LSRD", KOC_opcode, 1, 178},
   {"MUL", KOC_opcode, 1, 179}, {"NEG", KOC_opcode, 3, 180}, {"NEGA", KOC_opcode, 1, 183}, {"NEGB", KOC_opcode, 1, 184},
   {"NOP", KOC_opcode, 1, 185}, {"ORA", KOC_opcode, 3, 186}, {"ORAA", KOC_opcode, 3, 189}, {"ORAB", KOC_opcode, 3, 192},
   {"ORG", KOC_ORG, 0, 0}, {"PSH", KOC_opcode, 2, 195}, {"PSHA", KOC_opcode, 1, 197}, {"PSHB", KOC_opcode, 1, 198},
   {"PSHX", KOC_opcode, 1, 199}, {"PSHY", KOC_opcode, 1, 200}, {"PUL", KOC_opcode, 2, 201}, {"PULA", KOC_opcode, 1, 203},
   {"PULB", KOC_opcode, 1, 204}, {"PULX", KOC_opcode, 1, 205}, {"PULY", KOC_opcode, 1, 206}, {"RESERVE", KOC_RESM, 0, 0},
   {"RMB", KOC_RESM, 0, 0}, {"ROL", KOC_opcode, 3, 207}, {"ROLA", KOC_opcode, 1, 210}, {"ROLB", KOC_opcode, 1, 211},
   {"ROR", KOC_opcode, 3, 212}, {"RORA", KOC_opcode, 1, 215}, {"RORB", KOC_opcode, 1, 216}, {"RTI", KOC_opcode, 1, 217},
   {"RTS", KOC_opcode, 1, 218}, {"SBA", KOC_opcode, 1, 219}, {"SBC", KOC_opcode, 3, 220}, {"SBCA", KOC_opcode, 3, 223},
   {"SBCB", KOC_opcode, 3, 226}, {"SEC", KOC_opcode, 1, 229}, {"SEI", KOC_opcode, 1, 230}, {"SET", KOC_SET, 0, 0},
   {"SEV", KOC_opcode, 1, 231}, {"STA", KOC_opcode, 2, 232}, {"STAA", KOC_opcode, 2, 234}, {"STAB", KOC_opcode, 2, 236},
   {"STD", KOC_opcode, 2, 238}, {"STOP", KOC_opcode, 1, 240}, {"STRING", KOC_SDEF, 0, 0}, {"STS", KOC_opcode, 2, 241},
   {"STX", KOC_opcode, 2, 243}, {"STY", KOC_opcode, 2, 245}, {"SUB", KOC_opcode, 3, 247}, {"SUBA", KOC_opcode, 3, 250},
   {"SUBB", KOC_opcode, 3, 253}, {"SUBD", KOC_opcode, 3, 256}, {"SWI", KOC_opcode, 1, 259}, {"TAB", KOC_opcode, 1, 260},
   {"TAP", KOC_opcode, 1, 261}, {"TBA", KOC_opcode, 1, 262}, {"TEST", KOC_opcode, 1, 263}, {"TPA", KOC_opcode, 1, 264},
   {"TST", KOC_opcode, 3, 265}, {"TSTA", KOC_opcode, 1, 268}, {"TSTB", KOC_opcode, 1, 269}, {"TSX", KOC_opcode, 1, 270},
   {"TSY", KOC_opcode, 1, 271}, {"TXS", KOC_opcode, 1, 272}, {"TYS", KOC_opcode, 1, 273}, {"WAI", KOC_opcode, 1, 274},
   {"WORD", KOC_WDEF, 0, 0}, {"XGDX", KOC_opcode, 1, 275}, {"XGDY", KOC_opcode, 1, 276},
   {"", 0, 0, 0}
};
