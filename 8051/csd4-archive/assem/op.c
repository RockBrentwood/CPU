...
Mode ModeTab[] = {
/* acall */ { 0x11, ".",   "P" },
/* add */   { 0x24, "A#",  "b" },  { 0x26, "Ai",  "i" }, { 0x25, "A.",  "D" }, { 0x28, "An",  "n" },
/* addc */  { 0x34, "A#",  "b" },  { 0x36, "Ai",  "i" }, { 0x35, "A.",  "D" }, { 0x38, "An",  "n" },
/* ajmp */  { 0x01, ".",   "P" },
/* anl */   { 0x54, "A#",  "b" },  { 0x56, "Ai",  "i" }, { 0x55, "A.",  "D" }, { 0x58, "An",  "n" },
            { 0xb0, "C/",  "B" },  { 0x82, "C.",  "B" }, { 0x53, ".#",  "Db" },{ 0x52, ".A",  "D" },
/* cjne */  { 0xb6, "i#.", "ibR" },{ 0xb4, "A#.", "bR" },{ 0xb5, "A..", "DR" },{ 0xb8, "n#.", "nbR" },
/* clr */   { 0xe4, "A",   "" },   { 0xc2, ".",   "B" }, { 0xc3, "C",   "" },
/* cpl */   { 0xf4, "A",   "" },   { 0xb2, ".",   "B" }, { 0xb3, "C",   "" },
/* da */    { 0xd4, "A",   "" },
/* dec */   { 0x16, "i",   "i" },  { 0x14, "A",   ""},   { 0x15, ".",   "D" }, { 0x18, "n",   "n" },
/* div */   { 0x84, "B",   "" },
/* djnz */  { 0xd5, "..",  "DR" }, { 0xd8, "n.",  "nR" },
/* inc */   { 0x06, "i",   "i" },  { 0x04, "A",   "" },  { 0x05, ".",   "D" }, { 0xa3, "D",   "" },   { 0x08, "n",   "n" },
/* jb */    { 0x20, "..",  "BR" },
/* jbc */   { 0x10, "..",  "BR" },
/* jc */    { 0x40, ".",   "R" },
/* jmp */   { 0x73, ">",   "" },
...
/* movc */  { 0x93, "A>",  "" },   { 0x83, "A$",  "" },
/* movx */  { 0xf0, "@A",  "" },   { 0xf2, "iA",  "i" }, { 0xe0, "A@",  "" },  { 0xe2, "Ai",  "i" },
/* mul */   { 0xa4, "B",   "" },
/* nop */   { 0x00, "",    "" },
/* orl */   { 0x44, "A#",  "b" },  { 0x46, "Ai",  "i" }, { 0x45, "A.",  "D" }, { 0x48, "An",  "n" },
            { 0xa0, "C/",  "B" },  { 0x72, "C.",  "B" }, { 0x43, ".#",  "Db" },{ 0x42, ".A",  "D" },
/* pop */   { 0xd0, ".",   "D" },
/* push */  { 0xc0, ".",   "D" },
/* ret */   { 0x22, "",    "" },
/* reti */  { 0x32, "",    "" },
...
/* setb */  { 0xd2, ".",   "B" },  { 0xd3, "C",   "" },
/* sjmp */  { 0x80, ".",   "R" },
/* subb */  { 0x94, "A#",  "b" },  { 0x96, "Ai",  "i" }, { 0x95, "A.",  "D" }, { 0x98, "An",  "n" },
/* swap */  { 0xc4, "A",   "" },
...
void ParseArgs(byte Mnem) {
   ...
   *XP = 0, *EP = NULL;
   ...
   switch (*S) {
      ...
      case 'x': { Exp E = EP[0]; EP[0] = EP[1], EP[1] = E; S++; } break; // Swap arguments.
