...
static void InitFields(void) {
   ...
   CondOrders = (CondOrder *) malloc(sizeof(CondOrder) * CondOrderCnt);
   InstrZ = 0;
   AddCond("JTF", 0x16, 2, 3);
   AddCond("JNI", 0x86, 0, 2);
   AddCond("JC", 0xf6, 2, 3);
   AddCond("JNC", 0xe6, 2, 3);
   AddCond("JZ", 0xc6, 2, 3);
   AddCond("JNZ", 0x96, 2, 3);
   AddCond("JT0", 0x36, 1, 3);
   AddCond("JNT0", 0x26, 1, 3);
   AddCond("JT1", 0x56, 2, 3);
   AddCond("JNT1", 0x46, 2, 3);
   AddCond("JF0", 0xb6, 0, 3);
   AddCond("JF1", 0x76, 0, 3);
   AddCond("JNIBF", 0xd6, 2, 1);
   AddCond("JOBF", 0x86, 2, 1);
   AddCond("JB0", 0x12, 0, 3);
   AddCond("JB1", 0x32, 0, 3);
   AddCond("JB2", 0x52, 0, 3);
   AddCond("JB3", 0x72, 0, 3);
   AddCond("JB4", 0x92, 0, 3);
   AddCond("JB5", 0xb2, 0, 3);
   AddCond("JB6", 0xd2, 0, 3);
   AddCond("JB7", 0xf2, 0, 3);
   ...
   SelOrders = (SelOrder *) malloc(sizeof(SelOrder) * SelOrderCnt);
   InstrZ = 0;
      ...
      if (ArgCnt != 2) WrError(1110);
         ...
         if ((AdrMode == ModNone) || (AdrMode == ModAcc)) WrError(1350);
            ...
            switch (AdrMode) {
               ...
               case ModReg:
                  CodeLen = 1;
                  BAsmCode[0] = 0x68 + AdrVal;
                  break;
               case ModInd:
                  CodeLen = 1;
                  BAsmCode[0] = 0x60 + AdrVal;
                  break;
            }
   ...
   switch (ActPC) {
      case SegCode:
         switch (MomCPU - CPU8021) {
            case D_CPU8041:
               ok = (ProgCounter() < 0x400);
               break;
            case D_CPU8042:
               ok = (ProgCounter() < 0x800);
               break;
            default:
               ok = (ProgCounter() < 0x1000);
               break;
         }
         break;
      case SegXData:
