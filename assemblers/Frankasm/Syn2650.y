...
struct opsym optab[] = {
   {"invalid", KOC_opcode, 2, 0}, {"ACON", KOC_ACON, 0, 0}, {"ADDA", KOC_indexabs, 1, 2}, {"ADDI", KOC_opcode, 1, 3},
   {"ADDR", KOC_opcode, 2, 4}, {"ADDZ", KOC_opcode, 1, 6}, {"ANDA", KOC_indexabs, 1, 7}, {"ANDI", KOC_opcode, 1, 8},
   {"ANDR", KOC_opcode, 2, 9}, {"ANDZ", KOC_opcode, 1, 11}, {"BCFA", KOC_opcode, 2, 12}, {"BCFR", KOC_opcode, 2, 14},
   {"BCTA", KOC_opcode, 2, 16}, {"BCTR", KOC_opcode, 2, 18}, {"BDRA", KOC_opcode, 2, 20}, {"BDRR", KOC_opcode, 2, 22},
   {"BIRA", KOC_opcode, 2, 24}, {"BIRR", KOC_opcode, 2, 26}, {"BRNA", KOC_opcode, 2, 28}, {"BRNR", KOC_opcode, 2, 30},
   {"BSFA", KOC_opcode, 2, 32}, {"BSFR", KOC_opcode, 2, 34}, {"BSNA", KOC_opcode, 2, 36}, {"BSNR", KOC_opcode, 2, 38},
   {"BSTA", KOC_opcode, 2, 40}, {"BSTR", KOC_opcode, 2, 42}, {"BSXA", KOC_opcode, 2, 44}, {"BXA", KOC_opcode, 2, 46},
   {"BYTE", KOC_BDEF, 0, 0}, {"CHARDEF", KOC_CHDEF, 0, 0}, {"CHARSET", KOC_CHSET, 0, 0}, {"CHARUSE", KOC_CHUSE, 0, 0},
   {"CHD", KOC_CHDEF, 0, 0}, {"COMA", KOC_indexabs, 1, 48}, {"COMI", KOC_opcode, 1, 49}, {"COMR", KOC_opcode, 2, 50},
   {"COMZ", KOC_opcode, 1, 52}, {"CPSL", KOC_opcode, 1, 53}, {"CPSU", KOC_opcode, 1, 54}, {"DAR", KOC_opcode, 1, 55},
   {"DATA", KOC_BDEF, 0, 0}, {"DB", KOC_BDEF, 0, 0}, {"DW", KOC_WDEF, 0, 0}, {"ELSE", KOC_ELSE, 0, 0},
   {"END", KOC_END, 0, 0}, {"ENDI", KOC_ENDI, 0, 0}, {"EORA", KOC_indexabs, 1, 56}, {"EORI", KOC_opcode, 1, 57},
   {"EORR", KOC_opcode, 2, 58}, {"EORZ", KOC_opcode, 1, 60}, {"EQU", KOC_EQU, 0, 0}, {"FCB", KOC_BDEF, 0, 0},
   {"FCC", KOC_SDEF, 0, 0}, {"FDB", KOC_WDEF, 0, 0}, {"HALT", KOC_opcode, 1, 61}, {"IF", KOC_IF, 0, 0},
   {"INCL", KOC_INCLUDE, 0, 0}, {"INCLUDE", KOC_INCLUDE, 0, 0}, {"IORA", KOC_indexabs, 1, 62}, {"IORI", KOC_opcode, 1, 63},
   {"IORR", KOC_opcode, 2, 64}, {"IORZ", KOC_opcode, 1, 66}, {"LODA", KOC_indexabs, 1, 67}, {"LODI", KOC_opcode, 1, 68},
   {"LODR", KOC_opcode, 2, 69}, {"LODZ", KOC_opcode, 1, 71}, {"LPSL", KOC_opcode, 1, 72}, {"LPSU", KOC_opcode, 1, 73},
   {"NOP", KOC_opcode, 1, 74}, {"ORG", KOC_ORG, 0, 0}, {"PPSL", KOC_opcode, 1, 75}, {"PPSU", KOC_opcode, 1, 76},
   {"REDC", KOC_opcode, 1, 77}, {"REDD", KOC_opcode, 1, 78}, {"REDE", KOC_opcode, 1, 79}, {"RES", KOC_RESM, 0, 0},
   {"RESERVE", KOC_RESM, 0, 0}, {"RETC", KOC_opcode, 1, 80}, {"RETE", KOC_opcode, 1, 81}, {"RMB", KOC_RESM, 0, 0},
   {"RRL", KOC_opcode, 1, 82}, {"RRR", KOC_opcode, 1, 83}, {"SET", KOC_SET, 0, 0}, {"SPSL", KOC_opcode, 1, 84},
   {"SPSU", KOC_opcode, 1, 85}, {"STRA", KOC_indexabs, 1, 86}, {"STRING", KOC_SDEF, 0, 0}, {"STRR", KOC_opcode, 2, 87},
   {"STRZ", KOC_opcode, 1, 89}, {"SUBA", KOC_indexabs, 1, 90}, {"SUBI", KOC_opcode, 1, 91}, {"SUBR", KOC_opcode, 2, 92},
   {"SUBZ", KOC_opcode, 1, 94}, {"TMI", KOC_opcode, 1, 95}, {"TPSL", KOC_opcode, 1, 96}, {"TPSU", KOC_opcode, 1, 97},
   {"WORD", KOC_WDEF, 0, 0}, {"WRTC", KOC_opcode, 1, 98}, {"WRTD", KOC_opcode, 1, 99}, {"WRTE", KOC_opcode, 1, 100},
   {"ZBRR", KOC_opcode, 2, 101}, {"ZBSR", KOC_opcode, 2, 103},
   {"", 0, 0, 0}
};
