...
static void InitFields(void) {
   StdOrders = (StdOrder *) malloc(sizeof(StdOrder) * StdOrderCount);
   InstrZ = 0;
   AddStd("ADD", CPU29245, false, 0x14);
   AddStd("ADDC", CPU29245, false, 0x1c);
   AddStd("ADDCS", CPU29245, false, 0x18);
   AddStd("ADDCU", CPU29245, false, 0x1a);
   AddStd("ADDS", CPU29245, false, 0x10);
   AddStd("ADDU", CPU29245, false, 0x12);
   AddStd("AND", CPU29245, false, 0x90);
   AddStd("ANDN", CPU29245, false, 0x9c);
   AddStd("CPBYTE", CPU29245, false, 0x2e);
   AddStd("CPEQ", CPU29245, false, 0x60);
   AddStd("CPGE", CPU29245, false, 0x4c);
   AddStd("CPGEU", CPU29245, false, 0x4e);
   AddStd("CPGT", CPU29245, false, 0x48);
   AddStd("CPGTU", CPU29245, false, 0x4a);
   AddStd("CPLE", CPU29245, false, 0x44);
   AddStd("CPLEU", CPU29245, false, 0x46);
   AddStd("CPLT", CPU29245, false, 0x40);
   AddStd("CPLTU", CPU29245, false, 0x42);
   AddStd("CPNEQ", CPU29245, false, 0x62);
   AddStd("DIV", CPU29245, false, 0x6a);
   AddStd("DIV0", CPU29245, false, 0x68);
   AddStd("DIVL", CPU29245, false, 0x6c);
   AddStd("DIVREM", CPU29245, false, 0x6e);
   AddStd("EXBYTE", CPU29245, false, 0x0a);
   AddStd("EXHW", CPU29245, false, 0x7c);
   AddStd("EXTRACT", CPU29245, false, 0x7a);
   AddStd("INBYTE", CPU29245, false, 0x0c);
   AddStd("INHW", CPU29245, false, 0x78);
   AddStd("MUL", CPU29245, false, 0x64);
   AddStd("MULL", CPU29245, false, 0x66);
   AddStd("MULU", CPU29245, false, 0x74);
   AddStd("NAND", CPU29245, false, 0x9a);
   AddStd("NOR", CPU29245, false, 0x98);
   AddStd("OR", CPU29245, false, 0x92);
   AddStd("SLL", CPU29245, false, 0x80);
   AddStd("SRA", CPU29245, false, 0x86);
   AddStd("SRL", CPU29245, false, 0x82);
   AddStd("SUB", CPU29245, false, 0x24);
   AddStd("SUBC", CPU29245, false, 0x2c);
   AddStd("SUBCS", CPU29245, false, 0x28);
   AddStd("SUBCU", CPU29245, false, 0x2a);
   AddStd("SUBR", CPU29245, false, 0x34);
   AddStd("SUBRC", CPU29245, false, 0x3c);
   AddStd("SUBRCS", CPU29245, false, 0x38);
   AddStd("SUBRCU", CPU29245, false, 0x3a);
   AddStd("SUBRS", CPU29245, false, 0x30);
   AddStd("SUBRU", CPU29245, false, 0x32);
   AddStd("SUBS", CPU29245, false, 0x20);
   AddStd("SUBU", CPU29245, false, 0x22);
   AddStd("XNOR", CPU29245, false, 0x96);
   AddStd("XOR", CPU29245, false, 0x94);

   NoImmOrders = (StdOrder *) malloc(sizeof(StdOrder) * NoImmOrderCount);
   InstrZ = 0;
   AddNoImm("DADD", CPU29000, false, 0xf1);
   AddNoImm("DDIV", CPU29000, false, 0xf7);
   AddNoImm("DEQ", CPU29000, false, 0xeb);
   AddNoImm("DGE", CPU29000, false, 0xef);
   AddNoImm("DGT", CPU29000, false, 0xed);
   AddNoImm("DIVIDE", CPU29000, false, 0xe1);
   AddNoImm("DIVIDU", CPU29000, false, 0xe3);
   AddNoImm("DMUL", CPU29000, false, 0xf5);
   AddNoImm("DSUB", CPU29000, false, 0xf3);
   AddNoImm("FADD", CPU29000, false, 0xf0);
   AddNoImm("FDIV", CPU29000, false, 0xf6);
   AddNoImm("FDMUL", CPU29000, false, 0xf9);
   AddNoImm("FEQ", CPU29000, false, 0xea);
   AddNoImm("FGE", CPU29000, false, 0xee);
   AddNoImm("FGT", CPU29000, false, 0xec);
   AddNoImm("FMUL", CPU29000, false, 0xf4);
   AddNoImm("FSUB", CPU29000, false, 0xf2);
   AddNoImm("MULTIPLU", CPU29243, false, 0xe2);
   AddNoImm("MULTIPLY", CPU29243, false, 0xe0);
   AddNoImm("MULTM", CPU29243, false, 0xde);
   AddNoImm("MULTMU", CPU29243, false, 0xdf);
   AddNoImm("SETIP", CPU29245, false, 0x9e);

   VecOrders = (StdOrder *) malloc(sizeof(StdOrder) * VecOrderCount);
   InstrZ = 0;
   AddVec("ASEQ", CPU29245, false, 0x70);
   AddVec("ASGE", CPU29245, false, 0x5c);
   AddVec("ASGEU", CPU29245, false, 0x5e);
   AddVec("ASGT", CPU29245, false, 0x58);
   AddVec("ASGTU", CPU29245, false, 0x5a);
   AddVec("ASLE", CPU29245, false, 0x54);
   AddVec("ASLEU", CPU29245, false, 0x56);
   AddVec("ASLT", CPU29245, false, 0x50);
   AddVec("ASLTU", CPU29245, false, 0x52);
   AddVec("ASNEQ", CPU29245, false, 0x72);

   JmpOrders = (JmpOrder *) malloc(sizeof(JmpOrder) * JmpOrderCount);
   InstrZ = 0;
   AddJmp("CALL", CPU29245, true, true, 0xa8);
   AddJmp("JMP", CPU29245, false, true, 0xa0);
   AddJmp("JMPF", CPU29245, true, true, 0xa4);
   AddJmp("JMPFDEC", CPU29245, true, false, 0xb4);
   AddJmp("JMPT", CPU29245, true, true, 0xac);

   FixedOrders = (StdOrder *) malloc(sizeof(StdOrder) * FixedOrderCount);
   InstrZ = 0;
   AddFixed("HALT", CPU29245, true, 0x89);
   AddFixed("IRET", CPU29245, true, 0x88);

   MemOrders = (StdOrder *) malloc(sizeof(StdOrder) * MemOrderCount);
   InstrZ = 0;
   AddMem("LOAD", CPU29245, false, 0x16);
   AddMem("LOADL", CPU29245, false, 0x06);
   AddMem("LOADM", CPU29245, false, 0x36);
   AddMem("LOADSET", CPU29245, false, 0x26);
   AddMem("STORE", CPU29245, false, 0x1e);
   AddMem("STOREL", CPU29245, false, 0x0e);
   AddMem("STOREM", CPU29245, false, 0x3e);

   SPRegs = (SPReg *) malloc(sizeof(SPReg) * SPRegCount);
   InstrZ = 0;
   AddSP("VAB", 0);
   AddSP("OPS", 1);
   AddSP("CPS", 2);
...
#define ONOFF29KCount 1
   static ONOFFRec ONOFF29Ks[ONOFF29KCount] = { { "SUPMODE", &SupAllowed, SupAllowedName } };
#define ASSUME29KCount 1
   static ASSUMERec ASSUME29Ks[ASSUME29KCount] = { { "RBP", &Reg_RBP, 0, 0xff, 0x00000000 } };
   ...
   for (z = 0; z < FixedOrderCount; z++)
      if (Memo(FixedOrders[z].Name)) {
         if (ArgCnt != 0) WrError(1110);
            ...
            CodeLen = 4;
            DAsmCode[0] = FixedOrders[z].Code << 24;
