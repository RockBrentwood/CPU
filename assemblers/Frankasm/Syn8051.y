...
bit: expr '.' CONSTANT {
   ...
   pevalexpr(0, $1);
   if (evalr[0].seg != SSG_ABS)
      fraerror("noncomputable expression in bit address"),
      evalr[0].value = 0;
   else switch ((int)(evalr[0].value)) {
      case 0x20: case 0x21: case 0x22: case 0x23: case 0x24: case 0x25: case 0x26: case 0x27:
      case 0x28: case 0x29: case 0x2a: case 0x2b: case 0x2c: case 0x2d: case 0x2e: case 0x2f:
         bitaddr = (evalr[0].value - 0x20) << 3;
      break;
      ...
      break;
      default:
         fraerror("location is not bit addressable"), evalr[0].value = 0;
      break;
   }
   if ($3 < 0 || $3 > 7)
...
struct opsym optab[] = {
   {"invalid", KOC_opcode, 2, 0}, {"ACALL", KOC_opcode, 1, 2}, {"ADD", KOC_aluop, 4, 3}, {"ADDC", KOC_aluop, 4, 7},
   {"AJMP", KOC_opcode, 1, 11}, {"ANL", KOC_aluop, 9, 12}, {"BYTE", KOC_BDEF, 0, 0}, {"CHARDEF", KOC_CHDEF, 0, 0},
   {"CHARSET", KOC_CHSET, 0, 0}, {"CHARUSE", KOC_CHUSE, 0, 0}, {"CHD", KOC_CHDEF, 0, 0}, {"CJNE", KOC_cjne, 3, 21},
   {"CLR", KOC_opcode, 3, 24}, {"CPL", KOC_opcode, 3, 27}, {"DA", KOC_opcode, 1, 30}, {"DB", KOC_BDEF, 0, 0},
   {"DEC", KOC_opcode, 3, 31}, {"DIV", KOC_opcode, 1, 34}, {"DJNZ", KOC_aluop, 2, 35}, {"DW", KOC_WDEF, 0, 0},
   {"ELSE", KOC_ELSE, 0, 0}, {"END", KOC_END, 0, 0}, {"ENDI", KOC_ENDI, 0, 0}, {"EQU", KOC_EQU, 0, 0},
   {"FCB", KOC_BDEF, 0, 0}, {"FCC", KOC_SDEF, 0, 0}, {"FDB", KOC_WDEF, 0, 0}, {"IF", KOC_IF, 0, 0},
   {"INC", KOC_opcode, 3, 37}, {"INCL", KOC_INCLUDE, 0, 0}, {"INCLUDE", KOC_INCLUDE, 0, 0}, {"JB", KOC_aluop, 2, 40},
   {"JBC", KOC_aluop, 2, 42}, {"JC", KOC_opcode, 1, 44}, {"JMP", KOC_opcode, 1, 45}, {"JNB", KOC_aluop, 2, 46},
   {"JNC", KOC_opcode, 1, 48}, {"JNZ", KOC_opcode, 1, 49}, {"JZ", KOC_opcode, 1, 50}, {"LCALL", KOC_opcode, 1, 51},
   {"LJMP", KOC_opcode, 1, 52}, {"MOV", KOC_mov, 13, 53}, {"MOVC", KOC_mov, 1, 66}, {"MOVX", KOC_mov, 2, 67},
   {"MUL", KOC_opcode, 1, 69}, {"NOP", KOC_opcode, 1, 70}, {"ORG", KOC_ORG, 0, 0}, {"ORL", KOC_aluop, 9, 71},
   {"POP", KOC_opcode, 1, 80}, {"PUSH", KOC_opcode, 1, 81}, {"RESERVE", KOC_RESM, 0, 0}, {"RET", KOC_opcode, 1, 82},
   {"RETI", KOC_opcode, 1, 83}, {"RL", KOC_opcode, 1, 84}, {"RLC", KOC_opcode, 1, 85}, {"RMB", KOC_RESM, 0, 0},
   {"RR", KOC_opcode, 1, 86}, {"RRC", KOC_opcode, 1, 87}, {"SET", KOC_SET, 0, 0}, {"SETB", KOC_opcode, 3, 88},
   {"SJMP", KOC_opcode, 1, 91}, {"STRING", KOC_SDEF, 0, 0}, {"SUBB", KOC_aluop, 4, 92}, {"SWAP", KOC_opcode, 1, 96},
   {"WORD", KOC_WDEF, 0, 0}, {"XCH", KOC_aluop, 3, 97}, {"XCHD", KOC_aluop, 1, 100}, {"XRL", KOC_aluop, 6, 101},
   {"", 0, 0, 0}
};
...
/* ACALL 2 */ {0, 0, "[1=].Q.2+.f800&-.bI~.3}.e0&.11|;!.ff&;"},
/* ADD 3 */ {REGSEL_ACC, REGSEL_ACC, "24;[2=];"},
/* ADD 4 */ {REGSEL_ACC | REG2SEL_R01, REGSEL_ACC | REG2SEL_R01, "26.[2#]|;"},
/* ADD 5 */ {REGSEL_ACC | REG2SEL_R07, REGSEL_ACC | REG2SEL_R07, "28.[2#]|;"},
/* ADD 6 */ {REGSEL_ACC, REGSEL_ACC, "25;[2=].8I;"},
/* ADDC 7 */ {REGSEL_ACC, REGSEL_ACC, "34;[2=];"},
/* ADDC 8 */ {REGSEL_ACC | REG2SEL_R01, REGSEL_ACC | REG2SEL_R01, "36.[2#]|;"},
/* ADDC 9 */ {REGSEL_ACC | REG2SEL_R07, REGSEL_ACC | REG2SEL_R07, "38.[2#]|;"},
/* ADDC 10 */ {REGSEL_ACC, REGSEL_ACC, "35;[2=].8I;"},
/* AJMP 11 */ {0, 0, "[1=].Q.2+.f800&-.bI~.3}.e0&.01|;!.ff&;"},
/* ANL 12 */ {REGSEL_ACC, REGSEL_ACC, "54;[2=];"},
/* ANL 13 */ {REGSEL_C, REGSEL_C, "b0;[2#];"},
/* ANL 14 */ {REGSEL_C, REGSEL_C, "b0;[2=].8I;"},
/* ANL 15 */ {REGSEL_ACC | REG2SEL_R01, REGSEL_ACC | REG2SEL_R01, "56.[2#]|;"},
/* ANL 16 */ {REGSEL_ACC | REG2SEL_R07, REGSEL_ACC | REG2SEL_R07, "58.[2#]|;"},
/* ANL 17 */ {REGSEL_C, REGSEL_C, "82;[2#];"},
/* ANL 18 */ {REGSEL_ACC, REGSEL_ACC, "55;[2=].8I;"},
/* ANL 19 */ {REGSEL_C, REGSEL_C, "82;[2=].8I;"},
/* ANL 20 */ {0, 0, "53;[1=].8I;[2=];"},
/* ANL 21 */ {REGSEL_ACC, REGSEL_ACC, "52;[1=].8I;"},
/* CJNE 22 */ {REGSEL_ACC, REGSEL_ACC, "b5;[2=].8I;[3=].Q.1+-r"},
/* CJNE 23 */ {REGSEL_ACC, REGSEL_ACC, "b4;[2=];[3=].Q.1+-r"},
/* CJNE 24 */ {REGSEL_R07, REGSEL_R07, "b8.[1#]|;[2=];[3=].Q.1+-r"},
/* CJNE 25 */ {REGSEL_R01, REGSEL_R01, "b6.[1#]|;[2=];[3=].Q.1+-r"},
/* CLR 26 */ {REGSEL_ACC, REGSEL_ACC, "e4;"},
/* CLR 27 */ {REGSEL_C, REGSEL_C, "c3;"},
/* CLR 28 */ {0, 0, "c2;[1#];"},
/* CLR 29 */ {0, 0, "c2;[1=].8I;"},
/* CPL 30 */ {REGSEL_ACC, REGSEL_ACC, "f4;"},
/* CPL 31 */ {REGSEL_C, REGSEL_C, "b3;"},
/* CPL 32 */ {0, 0, "b2;[1#];"},
/* CPL 33 */ {0, 0, "b2;[1=].8I;"},
/* DA 34 */ {REGSEL_ACC, REGSEL_ACC, "d4;"},
/* DEC 35 */ {REGSEL_R01, REGSEL_R01, "16.[1#]|;"},
/* DEC 36 */ {REGSEL_ACC, REGSEL_ACC, "14;"},
/* DEC 37 */ {REGSEL_R07, REGSEL_R07, "18.[1#]|;"},
/* DEC 38 */ {0, 0, "15;[1=].8I;"},
/* DIV 39 */ {REGSEL_AB, REGSEL_AB, "84;"},
/* DJNZ 40 */ {REGSEL_R07, REGSEL_R07, "d8.[1#]|;[2=].Q.1+-r"},
/* DJNZ 41 */ {0, 0, "d5;[1=].8I;[2=].Q.1+-r"},
/* INC 42 */ {REGSEL_R01, REGSEL_R01, "06.[1#]|;"},
/* INC 43 */ {REGSEL_ACC, REGSEL_ACC, "04;"},
/* INC 44 */ {REGSEL_R07, REGSEL_R07, "08.[1#]|;"},
/* INC 45 */ {REGSEL_DPTR, REGSEL_DPTR, "a3;"},
/* INC 46 */ {0, 0, "05;[1=].8I;"},
/* JB 47 */ {0, 0, "20;[1#];[2=].Q.1+-r"},
/* JB 48 */ {0, 0, "20;[1=].8I;[2=].Q.1+-r"},
/* JBC 49 */ {0, 0, "10;[1#];[2=].Q.1+-r"},
/* JBC 50 */ {0, 0, "10;[1=].8I;[2=].Q.1+-r"},
/* JC 51 */ {0, 0, "40;[1=].Q.1+-r"},
/* JMP 52 */ {REGSEL_ACC | REG2SEL_DPTR, REGSEL_ACC | REG2SEL_DPTR, "73;"},
/* JNB 53 */ {0, 0, "30;[1#];[2=].Q.1+-r"},
/* JNB 54 */ {0, 0, "30;[1=].8I;[2=].Q.1+-r"},
/* JNC 55 */ {0, 0, "50;[1=].Q.1+-r"},
/* JNZ 56 */ {0, 0, "70;[1=].Q.1+-r"},
/* JZ 57 */ {0, 0, "60;[1=].Q.1+-r"},
/* LCALL 58 */ {0, 0, "12;[1=]x"},
/* LJMP 59 */ {0, 0, "02;[1=]x"},
/* MOV 60 */ {REGSEL_R01, REGSEL_R01, "76.[1#]|;[2=];"},
/* MOV 61 */ {REGSEL_R01 | REG2SEL_ACC, REGSEL_R01 | REG2SEL_ACC, "f6.[1#]|;"},
/* MOV 62 */ {REGSEL_R01, REGSEL_R01, "a6.[1#]|;[2=].8I;"},
/* MOV 63 */ {REGSEL_ACC, REGSEL_ACC, "74;[2=];"},
/* MOV 64 */ {REGSEL_DPTR, REGSEL_DPTR, "90;[2=]x"},
/* MOV 65 */ {REGSEL_R07, REGSEL_R07, "78.[1#]|;[2=];"},
/* MOV 66 */ {REGSEL_ACC | REG2SEL_R01, REGSEL_ACC | REG2SEL_R01, "e6.[2#]|;"},
/* MOV 67 */ {REGSEL_ACC | REG2SEL_R07, REGSEL_ACC | REG2SEL_R07, "e8.[2#]|;"},
/* MOV 68 */ {REGSEL_R07 | REG2SEL_ACC, REGSEL_R07 | REG2SEL_ACC, "f8.[1#]|;"},
/* MOV 69 */ {REGSEL_C, REGSEL_C, "a2;[2#];"},
/* MOV 70 */ {REGSEL_ACC, REGSEL_ACC, "e5;[2=].8I;"},
/* MOV 71 */ {REGSEL_C, REGSEL_C, "a2;[2=].8I;"},
/* MOV 72 */ {REGSEL_R07, REGSEL_R07, "a8.[1#]|;[2=].8I;"},
/* MOV 73 */ {REGSEL_C, REGSEL_C, "92;[1#];"},
/* MOV 74 */ {0, 0, "75;[1=].8I;[2=];"},
/* MOV 75 */ {REGSEL_R01, REGSEL_R01, "86.[2#]|;[1=].8I;"},
/* MOV 76 */ {REGSEL_ACC, REGSEL_ACC, "f5;[1=].8I;"},
/* MOV 77 */ {REGSEL_C, REGSEL_C, "92;[1=].8I;"},
/* MOV 78 */ {REGSEL_R07, REGSEL_R07, "88.[2#]|;[1=].8I;"},
/* MOV 79 */ {0, 0, "85;[2=].8I;[1=].8I;"},
/* MOVC 80 */ {REGSEL_ACC | REG2SEL_DPTR, REGSEL_ACC | REG2SEL_DPTR, "93;"},
/* MOVC 81 */ {REGSEL_ACC | REG2SEL_PC, REGSEL_ACC | REG2SEL_PC, "83;"},
/* MOVX 82 */ {REGSEL_DPTR | REG2SEL_ACC, REGSEL_DPTR | REG2SEL_ACC, "f0;"},
/* MOVX 83 */ {REGSEL_R01 | REG2SEL_ACC, REGSEL_R01 | REG2SEL_ACC, "f2.[1#]|;"},
/* MOVX 84 */ {REGSEL_ACC | REG2SEL_DPTR, REGSEL_ACC | REG2SEL_DPTR, "e0;"},
/* MOVX 85 */ {REGSEL_ACC | REG2SEL_R01, REGSEL_ACC | REG2SEL_R01, "e2.[2#]|;"},
/* MUL 86 */ {REGSEL_AB, REGSEL_AB, "a4;"},
/* NOP 87 */ {0, 0, "00;"},
/* ORL 88 */ {REGSEL_ACC, REGSEL_ACC, "44;[2=];"},
/* ORL 89 */ {REGSEL_C, REGSEL_C, "a0;[2#];"},
/* ORL 90 */ {REGSEL_C, REGSEL_C, "a0;[2=].8I;"},
/* ORL 91 */ {REGSEL_ACC | REG2SEL_R01, REGSEL_ACC | REG2SEL_R01, "46.[2#]|;"},
/* ORL 92 */ {REGSEL_ACC | REG2SEL_R07, REGSEL_ACC | REG2SEL_R07, "48.[2#]|;"},
/* ORL 93 */ {REGSEL_C, REGSEL_C, "72;[2#];"},
/* ORL 94 */ {REGSEL_ACC, REGSEL_ACC, "45;[2=].8I;"},
/* ORL 95 */ {REGSEL_C, REGSEL_C, "72;[2=].8I;"},
/* ORL 96 */ {0, 0, "43;[1=].8I;[2=];"},
/* ORL 97 */ {REGSEL_ACC, REGSEL_ACC, "42;[1=].8I;"},
/* POP 98 */ {0, 0, "d0;[1=].8I;"},
/* PUSH 99 */ {0, 0, "c0;[1=].8I;"},
/* RET 100 */ {0, 0, "22;"},
/* RETI 101 */ {0, 0, "32;"},
/* RL 102 */ {REGSEL_ACC, REGSEL_ACC, "23;"},
/* RLC 103 */ {REGSEL_ACC, REGSEL_ACC, "33;"},
/* RR 104 */ {REGSEL_ACC, REGSEL_ACC, "03;"},
/* RRC 105 */ {REGSEL_ACC, REGSEL_ACC, "13;"},
/* SETB 106 */ {REGSEL_C, REGSEL_C, "d3;"},
/* SETB 107 */ {0, 0, "d2;[1#];"},
/* SETB 108 */ {0, 0, "d2;[1=].8I;"},
/* SJMP 109 */ {0, 0, "80;[1=].Q.1+-r"},
/* SUBB 110 */ {REGSEL_ACC, REGSEL_ACC, "94;[2=];"},
/* SUBB 111 */ {REGSEL_ACC | REG2SEL_R01, REGSEL_ACC | REG2SEL_R01, "96.[2#]|;"},
/* SUBB 112 */ {REGSEL_ACC | REG2SEL_R07, REGSEL_ACC | REG2SEL_R07, "98.[2#]|;"},
/* SUBB 113 */ {REGSEL_ACC, REGSEL_ACC, "95;[2=].8I;"},
/* SWAP 114 */ {REGSEL_ACC, REGSEL_ACC, "c4;"},
/* XCH 115 */ {REGSEL_ACC | REG2SEL_R01, REGSEL_ACC | REG2SEL_R01, "c6.[2#]|;"},
/* XCH 116 */ {REGSEL_ACC | REG2SEL_R07, REGSEL_ACC | REG2SEL_R07, "c8.[2#]|;"},
/* XCH 117 */ {REGSEL_ACC, REGSEL_ACC, "c5;[2=].8I;"},
/* XCHD 118 */ {REGSEL_ACC | REG2SEL_R01, REGSEL_ACC | REG2SEL_R01, "d6.[2#]|;"},
/* XRL 119 */ {REGSEL_ACC, REGSEL_ACC, "64;[2=];"},
/* XRL 120 */ {REGSEL_ACC | REG2SEL_R01, REGSEL_ACC | REG2SEL_R01, "66.[2#]|;"},
/* XRL 121 */ {REGSEL_ACC | REG2SEL_R07, REGSEL_ACC | REG2SEL_R07, "68.[2#]|;"},
/* XRL 122 */ {REGSEL_ACC, REGSEL_ACC, "65;[2=].8I;"},
/* XRL 123 */ {0, 0, "63;[1=].8I;[2=];"},
/* XRL 124 */ {REGSEL_ACC, REGSEL_ACC, "62;[1=].8I;"},
   {0, 0, ""}
};
