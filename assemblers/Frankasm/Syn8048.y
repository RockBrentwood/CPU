...
line: KOC_CPU STRING {
   if (!cpumatch($2)) fraerror("unknown cpu type, 80C50 assumed"), cpuselect = CPU80C50;
};
...
struct opsym optab[] = {
   {"invalid", KOC_opcode, 2, 0}, {"ADD", KOC_opcode, 3, 2}, {"ADDC", KOC_opcode, 3, 5}, {"ANL", KOC_opcode, 4, 8},
   {"ANLD", KOC_opcode, 1, 12}, {"BYTE", KOC_BDEF, 0, 0}, {"CALL", KOC_opcode, 1, 13}, {"CHARDEF", KOC_CHDEF, 0, 0},
   {"CHARSET", KOC_CHSET, 0, 0}, {"CHARUSE", KOC_CHUSE, 0, 0}, {"CHD", KOC_CHDEF, 0, 0}, {"CLR", KOC_opcode, 1, 14},
   {"CPL", KOC_opcode, 1, 15}, {"CPU", KOC_CPU, 0, 0}, {"DA", KOC_opcode, 1, 16}, {"DB", KOC_BDEF, 0, 0},
   {"DEC", KOC_opcode, 2, 17}, {"DIS", KOC_misc, 1, 19}, {"DJNZ", KOC_opcode, 1, 20}, {"DW", KOC_WDEF, 0, 0},
   {"ELSE", KOC_ELSE, 0, 0}, {"EN", KOC_misc, 1, 21}, {"END", KOC_END, 0, 0}, {"ENDI", KOC_ENDI, 0, 0},
   {"ENT0", KOC_misc, 1, 22}, {"EQU", KOC_EQU, 0, 0}, {"FCB", KOC_BDEF, 0, 0}, {"FCC", KOC_SDEF, 0, 0},
   {"FDB", KOC_WDEF, 0, 0}, {"HALT", KOC_misc, 1, 23}, {"IDL", KOC_misc, 1, 24}, {"IF", KOC_IF, 0, 0},
   {"IN", KOC_opcode, 1, 25}, {"INC", KOC_opcode, 3, 26}, {"INCL", KOC_INCLUDE, 0, 0}, {"INCLUDE", KOC_INCLUDE, 0, 0},
   {"INS", KOC_opcode, 1, 29}, {"JB0", KOC_opcode, 1, 30}, {"JB1", KOC_opcode, 1, 31}, {"JB2", KOC_opcode, 1, 32},
   {"JB3", KOC_opcode, 1, 33}, {"JB4", KOC_opcode, 1, 34}, {"JB5", KOC_opcode, 1, 35}, {"JB6", KOC_opcode, 1, 36},
   {"JB7", KOC_opcode, 1, 37}, {"JC", KOC_opcode, 1, 38}, {"JF0", KOC_opcode, 1, 39}, {"JF1", KOC_opcode, 1, 40},
   {"JMP", KOC_opcode, 1, 41}, {"JMPP", KOC_opcode, 1, 42}, {"JNC", KOC_opcode, 1, 43}, {"JNI", KOC_opcode, 1, 44},
   {"JNIBF", KOC_opcode, 1, 45}, {"JNT0", KOC_opcode, 1, 46}, {"JNT1", KOC_opcode, 1, 47}, {"JNZ", KOC_opcode, 1, 48},
   {"JOBF", KOC_opcode, 1, 49}, {"JT0", KOC_opcode, 1, 50}, {"JT1", KOC_opcode, 1, 51}, {"JTF", KOC_opcode, 1, 52},
   {"JZ", KOC_opcode, 1, 53}, {"MOV", KOC_mov, 9, 54}, {"MOVD", KOC_opcode, 2, 63}, {"MOVP3", KOC_mov, 1, 65},
   {"MOVP", KOC_mov, 1, 66}, {"MOVX", KOC_mov, 2, 67}, {"NOP", KOC_misc, 1, 69}, {"ORG", KOC_ORG, 0, 0},
   {"ORL", KOC_opcode, 4, 70}, {"ORLD", KOC_opcode, 1, 74}, {"OUT", KOC_opcode, 1, 75}, {"OUTL", KOC_opcode, 1, 76},
   {"REGISTER", KOC_REG, 0, 0}, {"RESERVE", KOC_RESM, 0, 0}, {"RET", KOC_misc, 1, 77}, {"RETR", KOC_misc, 1, 78},
   {"RL", KOC_opcode, 1, 79}, {"RLC", KOC_opcode, 1, 80}, {"RMB", KOC_RESM, 0, 0}, {"RR", KOC_opcode, 1, 81},
   {"RRC", KOC_opcode, 1, 82}, {"SEL", KOC_misc, 2, 83}, {"SET", KOC_SET, 0, 0}, {"STOP", KOC_misc, 1, 85},
   {"STRING", KOC_SDEF, 0, 0}, {"STRT", KOC_misc, 1, 86}, {"SWAP", KOC_opcode, 1, 87}, {"WORD", KOC_WDEF, 0, 0},
   {"XCH", KOC_opcode, 2, 88}, {"XCHD", KOC_opcode, 1, 90}, {"XRL", KOC_opcode, 3, 91},
   {"", 0, 0, 0}
};
