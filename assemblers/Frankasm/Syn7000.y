...
expr: '(' expr ')' { $$ = $2; };
expr: REG { $$ = exprnode(PCCASE_CONS, 0, 'V', 0, (long)$1, NULL); };
%%
...
struct opsym optab[] = {
   {"invalid", KOC_opcode, 2, 0}, {"ADC", KOC_opcode, 2, 2}, {"ADD", KOC_opcode, 2, 4}, {"AND", KOC_opcode, 2, 6},
   {"ANDP", KOC_opcode, 2, 8}, {"BR", KOC_opcode, 3, 10}, {"BTJO", KOC_opcode, 2, 13}, {"BTJOP", KOC_opcode, 2, 15},
   {"BTJZ", KOC_opcode, 2, 17}, {"BTJZP", KOC_opcode, 2, 19}, {"BYTE", KOC_BDEF, 0, 0}, {"CALL", KOC_opcode, 3, 21},
   {"CHARDEF", KOC_CHDEF, 0, 0}, {"CHARSET", KOC_CHSET, 0, 0}, {"CHARUSE", KOC_CHUSE, 0, 0}, {"CHD", KOC_CHDEF, 0, 0},
   {"CLR", KOC_opcode, 1, 24}, {"CLRC", KOC_opcode, 1, 25}, {"CMP", KOC_opcode, 2, 26}, {"CMPA", KOC_opcode, 3, 28},
   {"DAC", KOC_opcode, 2, 31}, {"DB", KOC_BDEF, 0, 0}, {"DEC", KOC_opcode, 1, 33}, {"DECD", KOC_opcode, 1, 34},
   {"DINT", KOC_opcode, 1, 35}, {"DJNZ", KOC_opcode, 1, 36}, {"DSB", KOC_opcode, 2, 37}, {"DW", KOC_WDEF, 0, 0},
   {"EINT", KOC_opcode, 1, 39}, {"ELSE", KOC_ELSE, 0, 0}, {"END", KOC_END, 0, 0}, {"ENDI", KOC_ENDI, 0, 0},
   {"EQU", KOC_EQU, 0, 0}, {"FCB", KOC_BDEF, 0, 0}, {"FCC", KOC_SDEF, 0, 0}, {"FDB", KOC_WDEF, 0, 0},
   {"IDLE", KOC_opcode, 1, 40}, {"IF", KOC_IF, 0, 0}, {"INC", KOC_opcode, 1, 41}, {"INCL", KOC_INCLUDE, 0, 0},
   {"INCLUDE", KOC_INCLUDE, 0, 0}, {"INV", KOC_opcode, 1, 42}, {"JC", KOC_opcode, 1, 43}, {"JEQ", KOC_opcode, 1, 44},
   {"JGE", KOC_opcode, 1, 45}, {"JGT", KOC_opcode, 1, 46}, {"JHS", KOC_opcode, 1, 47}, {"JL", KOC_opcode, 1, 48},
   {"JLT", KOC_opcode, 1, 49}, {"JMP", KOC_opcode, 1, 50}, {"JN", KOC_opcode, 1, 51}, {"JNC", KOC_opcode, 1, 52},
   {"JNE", KOC_opcode, 1, 53}, {"JNZ", KOC_opcode, 1, 54}, {"JP", KOC_opcode, 1, 55}, {"JPZ", KOC_opcode, 1, 56},
   {"JZ", KOC_opcode, 1, 57}, {"LDA", KOC_opcode, 3, 58}, {"LDSP", KOC_opcode, 1, 61}, {"MOV", KOC_opcode, 2, 62},
   {"MOVD", KOC_opcode, 3, 64}, {"MOVP", KOC_opcode, 2, 67}, {"MPY", KOC_opcode, 2, 69}, {"NOP", KOC_opcode, 1, 71},
   {"OR", KOC_opcode, 2, 72}, {"ORG", KOC_ORG, 0, 0}, {"ORP", KOC_opcode, 2, 74}, {"POP", KOC_opcode, 2, 76},
   {"PUSH", KOC_opcode, 2, 78}, {"RESERVE", KOC_RESM, 0, 0}, {"RETI", KOC_opcode, 1, 80}, {"RETS", KOC_opcode, 1, 81},
   {"RL", KOC_opcode, 1, 82}, {"RLC", KOC_opcode, 1, 83}, {"RMB", KOC_RESM, 0, 0}, {"RR", KOC_opcode, 1, 84},
   {"RRC", KOC_opcode, 1, 85}, {"SBB", KOC_opcode, 2, 86}, {"SET", KOC_SET, 0, 0}, {"SETC", KOC_opcode, 1, 88},
   {"STA", KOC_opcode, 3, 89}, {"STRING", KOC_SDEF, 0, 0}, {"STSP", KOC_opcode, 1, 92}, {"SUB", KOC_opcode, 2, 93},
   {"SWAP", KOC_opcode, 1, 95}, {"TRAP", KOC_opcode, 1, 96}, {"TSTA", KOC_opcode, 1, 97}, {"TSTB", KOC_opcode, 1, 98},
   {"WORD", KOC_WDEF, 0, 0}, {"XCHB", KOC_opcode, 1, 99}, {"XOR", KOC_opcode, 2, 100}, {"XORP", KOC_opcode, 2, 102},
   {"", 0, 0, 0}
};
