...
static void AddGen(char *NName, Word NCode, bool NMayI, bool NMayD, bool NMayE, ShortInt NSize) {
...
static void InitFields(void) {
   ...
   AddFixed("ABX", 0x1ae5);
   AddFixed("ABY", 0x19ed);
   AddFixed("ASLA", 0x0048);
   AddFixed("ASLB", 0x0058);
   AddFixed("ASLD", 0x0059);
   AddFixed("ASRA", 0x0047);
   AddFixed("ASRB", 0x0057);
   AddFixed("BGND", 0x0000);
   AddFixed("CBA", 0x1817);
   AddFixed("CLC", 0x10fe);
   AddFixed("CLI", 0x10ef);
   AddFixed("CLRA", 0x0087);
   AddFixed("CLRB", 0x00c7);
   AddFixed("CLV", 0x10fd);
   AddFixed("COMA", 0x0041);
   AddFixed("COMB", 0x0051);
   AddFixed("DAA", 0x1807);
   AddFixed("DECA", 0x0043);
   AddFixed("DECB", 0x0053);
   AddFixed("DES", 0x1b9f);
   AddFixed("DEX", 0x0009);
   AddFixed("DEY", 0x0003);
   AddFixed("EDIV", 0x0011);
   AddFixed("EDIVS", 0x1814);
   AddFixed("EMUL", 0x0013);
   AddFixed("EMULS", 0x1813);
   AddFixed("FDIV", 0x1811);
   AddFixed("IDIV", 0x1810);
   AddFixed("IDIVS", 0x1815);
   AddFixed("INCA", 0x0042);
   AddFixed("INCB", 0x0052);
   AddFixed("INS", 0x1b81);
   AddFixed("INX", 0x0008);
   AddFixed("INY", 0x0002);
   AddFixed("LSLA", 0x0048);
   AddFixed("LSLB", 0x0058);
   AddFixed("LSLD", 0x0059);
   AddFixed("LSRA", 0x0044);
   AddFixed("LSRB", 0x0054);
   AddFixed("LSRD", 0x0049);
   AddFixed("MEM", 0x0001);
   AddFixed("MUL", 0x0012);
   AddFixed("NEGA", 0x0040);
   AddFixed("NEGB", 0x0050);
   AddFixed("NOP", 0x00a7);
   AddFixed("PSHA", 0x0036);
   AddFixed("PSHB", 0x0037);
   AddFixed("PSHC", 0x0039);
   AddFixed("PSHD", 0x003b);
   AddFixed("PSHX", 0x0034);
   AddFixed("PSHY", 0x0035);
   AddFixed("PULA", 0x0032);
   AddFixed("PULB", 0x0033);
   AddFixed("PULC", 0x0038);
   AddFixed("PULD", 0x003a);
   AddFixed("PULX", 0x0030);
   AddFixed("PULY", 0x0031);
   AddFixed("REV", 0x183a);
   AddFixed("REVW", 0x183b);
   AddFixed("ROLA", 0x0045);
   AddFixed("ROLB", 0x0055);
   AddFixed("RORA", 0x0046);
   AddFixed("RORB", 0x0056);
   AddFixed("RTC", 0x000a);
   AddFixed("RTI", 0x000b);
   AddFixed("RTS", 0x003d);
   AddFixed("SBA", 0x1816);
   ...
   AddFixed("SEI", 0x1410);
   AddFixed("SEV", 0x1402);
   AddFixed("STOP", 0x183e);
   AddFixed("SWI", 0x003f);
   AddFixed("TAB", 0x180e);
   AddFixed("TAP", 0xb702);
   AddFixed("TBA", 0x180f);
   AddFixed("TPA", 0xb720);
   AddFixed("TSTA", 0x0097);
   AddFixed("TSTB", 0x00d7);
   AddFixed("TSX", 0xb775);
   AddFixed("TSY", 0xb776);
   AddFixed("TXS", 0xb757);
   AddFixed("TYS", 0xb767);
   ...
   for (z = 0; z < GenOrderCount; z++)
      if Memo
         ...
         if ((ArgCnt < 1) || (ArgCnt > 2)) WrError(1110);
            ...
            ExPos = 1 + (Hi(GenOrders[z].Code) != 0);
            OpSize = GenOrders[z].ThisOpSize;
            Mask = MModAllIdx;
...
/* Transfer */
   ...
   if ((Memo("MOVB")) || (Memo("MOVW"))) {
      ...
      if ((ArgCnt < 2) || (ArgCnt > 4)) WrError(1110);
         ...
         ExPos = 2;
         BAsmCode[0] = 0x18;
         BAsmCode[1] = Memo("MOVB") << 3;
         DecodeAdr(1, HReg - 1, MModImm + MModExt + MModIdx);
         switch (AdrMode) {
            case ModImm:
               memmove(AdrVals + 2, AdrVals, AdrCnt);
               HCnt = AdrCnt;
               ExPos = 4 + 2 * OpSize;
               DecodeAdr(HReg, ArgCnt, MModExt + MModIdx);
               switch (AdrMode) {
                  case ModExt:
                     BAsmCode[1] += 3;
   ...
   for (z = 0; z < JmpOrderCount; z++)
      if (Memo(JmpOrders[z].Name)) {
         if ((ArgCnt < 1) || (ArgCnt > 2)) WrError(1110);
            ...
            if (JmpOrders[z].MayDir) Mask += MModDir;
            ExPos = 1;
            DecodeAdr(1, ArgCnt, Mask);
            if (AdrMode != ModNone) {
               switch (AdrMode) {
                  case ModExt:
                     BAsmCode[0] = JmpOrders[z].Code;
                     break;
                  case ModDir:
                     BAsmCode[0] = JmpOrders[z].Code + 1;
                     break;
                  case ModIdx:
                  case ModIdx1:
                  case ModIdx2:
   ...
   if (Memo("CALL")) {
      if (ArgCnt < 1) WrError(1110);
         ...
         if (ArgCnt != 1) WrError(1110);
            ...
            ExPos = 1;
            DecodeAdr(1, 1, MModDIdx + MModIIdx2);
            if (AdrMode != ModNone) {
               BAsmCode[0] = 0x4b;
               memcpy(BAsmCode + 1, AdrVals, AdrCnt);
               CodeLen = 1 + AdrCnt;
