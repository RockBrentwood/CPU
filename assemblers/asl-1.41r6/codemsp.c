...
static void InitFields(void) {
   TwoOpOrders = (FixedOrder *) malloc(sizeof(FixedOrder) * TwoOpCount);
   InstrZ = 0;
   AddTwoOp("MOV", 0x4000);
   AddTwoOp("ADD", 0x5000);
   AddTwoOp("ADDC", 0x6000);
   AddTwoOp("SUBC", 0x7000);
   AddTwoOp("SUB", 0x8000);
   AddTwoOp("CMP", 0x9000);
   AddTwoOp("DADD", 0xa000);
   AddTwoOp("BIT", 0xb000);
   AddTwoOp("BIC", 0xc000);
   AddTwoOp("BIS", 0xd000);
   AddTwoOp("XOR", 0xe000);
   ...
   OneOpOrders = (OneOpOrder *) malloc(sizeof(OneOpOrder) * OneOpCount);
   InstrZ = 0;
   AddOneOp("RRC", true, 0x1000);
   AddOneOp("RRA", true, 0x1100);
   AddOneOp("PUSH", true, 0x1200);
   AddOneOp("SWPB", false, 0x1080);
   AddOneOp("CALL", false, 0x1280);
   AddOneOp("SXT", false, 0x1180);

   JmpOrders = (FixedOrder *) malloc(sizeof(FixedOrder) * JmpCount);
   InstrZ = 0;
   AddJmp("JNE", 0x2000);
   AddJmp("JNZ", 0x2000);
   AddJmp("JE", 0x2400);
...
#define ONOFF430Count 1
   static ONOFFRec ONOFF430s[ONOFF430Count] = { { "PADDING", &DoPadding, DoPaddingName } };
