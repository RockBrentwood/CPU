	...
	static void InitFields(void)
{
   ...
   AddSing8("ASL", 0x48); AddSing8("LSL", 0x48);
   AddSing8("ASR", 0x47); AddSing8("CLR", 0x4f);
   AddSing8("COM", 0x43); AddSing8("DEC", 0x4a);
   AddSing8("INC", 0x4c); AddSing8("LSR", 0x44);
   AddSing8("NEG", 0x40); AddSing8("ROL", 0x49);
        ...
        static bool SplitAcc(char *Op)
{
   ...
   if ((OpLen+1==OpPartLen) &&
       (strncmp(OpPart,Op,OpLen)==0) &&
       ((Ch=='A') || (Ch=='B')))
    {
