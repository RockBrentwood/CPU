...
line: KOC_CPU STRING {
   if (!cpumatch($2)) fraerror("unknown cpu type, 1805 assumed"), cpuselect = CPU1805;
};
...
struct opsym optab[] = {
   {"invalid", KOC_opcode, 2, 0}, {"ADC", KOC_opcode, 1, 2}, {"ADCI", KOC_opcode, 1, 3}, {"ADD", KOC_opcode, 1, 4},
   {"ADI", KOC_opcode, 1, 5}, {"AND", KOC_opcode, 1, 6}, {"ANI", KOC_opcode, 1, 7}, {"B1", KOC_opcode, 1, 8},
   {"B2", KOC_opcode, 1, 9}, {"B3", KOC_opcode, 1, 10}, {"B4", KOC_opcode, 1, 11}, {"BCI", KOC_opcode, 1, 12},
   {"BDF", KOC_opcode, 1, 13}, {"BGE", KOC_opcode, 1, 14}, {"BL", KOC_opcode, 1, 15}, {"BM", KOC_opcode, 1, 16},
   {"BN1", KOC_opcode, 1, 17}, {"BN2", KOC_opcode, 1, 18}, {"BN3", KOC_opcode, 1, 19}, {"BN4", KOC_opcode, 1, 20},
   {"BNF", KOC_opcode, 1, 21}, {"BNQ", KOC_opcode, 1, 22}, {"BNZ", KOC_opcode, 1, 23}, {"BPZ", KOC_opcode, 1, 24},
   {"BQ", KOC_opcode, 1, 25}, {"BR", KOC_opcode, 1, 26}, {"BXI", KOC_opcode, 1, 27}, {"BYTE", KOC_BDEF, 0, 0},
   {"BZ", KOC_opcode, 1, 28}, {"CHARDEF", KOC_CHDEF, 0, 0}, {"CHARSET", KOC_CHSET, 0, 0}, {"CHARUSE", KOC_CHUSE, 0, 0},
   {"CHD", KOC_CHDEF, 0, 0}, {"CID", KOC_opcode, 1, 29}, {"CIE", KOC_opcode, 1, 30}, {"CPU", KOC_CPU, 0, 0},
   {"DACI", KOC_opcode, 1, 31}, {"DADC", KOC_opcode, 1, 32}, {"DADD", KOC_opcode, 1, 33}, {"DADI", KOC_opcode, 1, 34},
   {"DB", KOC_BDEF, 0, 0}, {"DBNZ", KOC_dbnz, 1, 35}, {"DEC", KOC_regop, 1, 36}, {"DIS", KOC_opcode, 1, 37},
   {"DSAV", KOC_opcode, 1, 38}, {"DSBI", KOC_opcode, 1, 39}, {"DSM", KOC_opcode, 1, 40}, {"DSMB", KOC_opcode, 1, 41},
   {"DSMI", KOC_opcode, 1, 42}, {"DTC", KOC_opcode, 1, 43}, {"DW", KOC_WDEF, 0, 0}, {"ELSE", KOC_ELSE, 0, 0},
   {"END", KOC_END, 0, 0}, {"ENDI", KOC_ENDI, 0, 0}, {"EQU", KOC_EQU, 0, 0}, {"ETQ", KOC_opcode, 1, 44},
   {"FCB", KOC_BDEF, 0, 0}, {"FCC", KOC_SDEF, 0, 0}, {"FDB", KOC_WDEF, 0, 0}, {"GEC", KOC_opcode, 1, 45},
   {"GHI", KOC_regop, 1, 46}, {"GLO", KOC_regop, 1, 47}, {"IDL", KOC_opcode, 1, 48}, {"IF", KOC_IF, 0, 0},
   {"INC", KOC_regop, 1, 49}, {"INCL", KOC_INCLUDE, 0, 0}, {"INCLUDE", KOC_INCLUDE, 0, 0}, {"INP", KOC_ioop, 1, 50},
   {"IRX", KOC_opcode, 1, 51}, {"LBDF", KOC_opcode, 1, 52}, {"LBNF", KOC_opcode, 1, 53}, {"LBNQ", KOC_opcode, 1, 54},
   {"LBNZ", KOC_opcode, 1, 55}, {"LBQ", KOC_opcode, 1, 56}, {"LBR", KOC_opcode, 1, 57}, {"LBZ", KOC_opcode, 1, 58},
   {"LDA", KOC_regop, 1, 59}, {"LDC", KOC_opcode, 1, 60}, {"LDI", KOC_opcode, 1, 61}, {"LDN", KOC_ldn, 1, 62},
   {"LDX", KOC_opcode, 1, 63}, {"LDXA", KOC_opcode, 1, 64}, {"LSDF", KOC_opcode, 1, 65}, {"LSIE", KOC_opcode, 1, 66},
   {"LSKP", KOC_opcode, 1, 67}, {"LSNF", KOC_opcode, 1, 68}, {"LSNQ", KOC_opcode, 1, 69}, {"LSNZ", KOC_opcode, 1, 70},
   {"LSQ", KOC_opcode, 1, 71}, {"LSZ", KOC_opcode, 1, 72}, {"MARK", KOC_opcode, 1, 73}, {"NBR", KOC_opcode, 1, 74},
   {"NLBR", KOC_opcode, 1, 75}, {"NOP", KOC_opcode, 1, 76}, {"OR", KOC_opcode, 1, 77}, {"ORG", KOC_ORG, 0, 0},
   {"ORI", KOC_opcode, 1, 78}, {"OUT", KOC_ioop, 1, 79}, {"PHI", KOC_regop, 1, 80}, {"PLO", KOC_regop, 1, 81},
   {"REQ", KOC_opcode, 1, 82}, {"RESERVE", KOC_RESM, 0, 0}, {"RET", KOC_opcode, 1, 83}, {"RLDI", KOC_rldi, 1, 84},
   {"RLXA", KOC_regop, 1, 85}, {"RMB", KOC_RESM, 0, 0}, {"RNX", KOC_regop, 1, 86}, {"RSHL", KOC_opcode, 1, 87},
   {"RSHR", KOC_opcode, 1, 88}, {"RSXD", KOC_regop, 1, 89}, {"SAV", KOC_opcode, 1, 90}, {"SCAL", KOC_dbnz, 1, 91},
   {"SCM1", KOC_opcode, 1, 92}, {"SCM2", KOC_opcode, 1, 93}, {"SD", KOC_opcode, 1, 94}, {"SDB", KOC_opcode, 1, 95},
   {"SDBI", KOC_opcode, 1, 96}, {"SDI", KOC_opcode, 1, 97}, {"SEP", KOC_regop, 1, 98}, {"SEQ", KOC_opcode, 1, 99},
   {"SET", KOC_SET, 0, 0}, {"SEX", KOC_regop, 1, 100}, {"SHL", KOC_opcode, 1, 101}, {"SHLC", KOC_opcode, 1, 102},
   {"SHR", KOC_opcode, 1, 103}, {"SHRC", KOC_opcode, 1, 104}, {"SKP", KOC_opcode, 1, 105}, {"SM", KOC_opcode, 1, 106},
   {"SMB", KOC_opcode, 1, 107}, {"SMBI", KOC_opcode, 1, 108}, {"SMI", KOC_opcode, 1, 109}, {"SPM1", KOC_opcode, 1, 110},
   {"SPM2", KOC_opcode, 1, 111}, {"SRET", KOC_regop, 1, 112}, {"STM", KOC_opcode, 1, 113}, {"STPC", KOC_opcode, 1, 114},
   {"STR", KOC_regop, 1, 115}, {"STRING", KOC_SDEF, 0, 0}, {"STXD", KOC_opcode, 1, 116}, {"WORD", KOC_WDEF, 0, 0},
   {"XID", KOC_opcode, 1, 117}, {"XIE", KOC_opcode, 1, 118}, {"XOR", KOC_opcode, 1, 119}, {"XRI", KOC_opcode, 1, 120},
   {"", 0, 0, 0}
};
