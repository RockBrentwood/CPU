TITLE   "Single channel A/D (SNGLAD)"
;This program is a simple implementation of the PIC16C71's
;A/D. 1 Channel is selected (CH2).
...
;       A/D Channel = CH2
;
;The A/D result is displayed on a 3 digit LED display LTM8522. 
;
;
...
;
	call    InitializeAD   
update      
	bcf     flag,0          ;reset a/d flag
	bcf     ADCON0,1        ;reset a/d int flag (ADIF)
