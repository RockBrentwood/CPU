...
PLineInfoList LineInfoRoot;
	...
	void AddLineInfo(bool InASM, LongInt LineNum, char *FileName,
...
{
   TempFileName[0]='\0'; LineInfoRoot=NULL;
}
	...
	static void DumpDebugInfo_MAP(void)
{
   ...
   MAPFile=fopen(MAPName,"w"); if (MAPFile==NULL) ChkIO(10001);
