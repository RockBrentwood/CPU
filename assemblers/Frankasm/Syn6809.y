...
struct opsym optab[] = {
   {"invalid", KOC_opcode, 2, 0}, {"ABX", KOC_opcode, 1, 2}, {"ADCA", KOC_opcode, 3, 3}, {"ADCB", KOC_opcode, 3, 6},
   {"ADDA", KOC_opcode, 3, 9}, {"ADDB", KOC_opcode, 3, 12}, {"ADDD", KOC_opcode, 3, 15}, {"ANDA", KOC_opcode, 3, 18},
   {"ANDB", KOC_opcode, 3, 21}, {"ANDCC", KOC_opcode, 1, 24}, {"ASL", KOC_opcode, 2, 25}, {"ASLA", KOC_opcode, 1, 27},
   {"ASLB", KOC_opcode, 1, 28}, {"ASR", KOC_opcode, 2, 29}, {"ASRA", KOC_opcode, 1, 31}, {"ASRB", KOC_opcode, 1, 32},
   {"BCC", KOC_opcode, 1, 33}, {"BCS", KOC_opcode, 1, 34}, {"BEQ", KOC_opcode, 1, 35}, {"BGE", KOC_opcode, 1, 36},
   {"BGT", KOC_opcode, 1, 37}, {"BHI", KOC_opcode, 1, 38}, {"BHS", KOC_opcode, 1, 39}, {"BITA", KOC_opcode, 3, 40},
   {"BITB", KOC_opcode, 3, 43}, {"BLE", KOC_opcode, 1, 46}, {"BLO", KOC_opcode, 1, 47}, {"BLS", KOC_opcode, 1, 48},
   {"BLT", KOC_opcode, 1, 49}, {"BMI", KOC_opcode, 1, 50}, {"BNE", KOC_opcode, 1, 51}, {"BPL", KOC_opcode, 1, 52},
   {"BRA", KOC_opcode, 1, 53}, {"BRN", KOC_opcode, 1, 54}, {"BSR", KOC_opcode, 1, 55}, {"BVC", KOC_opcode, 1, 56},
   {"BVS", KOC_opcode, 1, 57}, {"BYTE", KOC_BDEF, 0, 0}, {"CHARDEF", KOC_CHDEF, 0, 0}, {"CHARSET", KOC_CHSET, 0, 0},
   {"CHARUSE", KOC_CHUSE, 0, 0}, {"CHD", KOC_CHDEF, 0, 0}, {"CLR", KOC_opcode, 2, 58}, {"CLRA", KOC_opcode, 1, 60},
   {"CLRB", KOC_opcode, 1, 61}, {"CMPA", KOC_opcode, 3, 62}, {"CMPB", KOC_opcode, 3, 65}, {"CMPD", KOC_opcode, 3, 68},
   {"CMPS", KOC_opcode, 3, 71}, {"CMPU", KOC_opcode, 3, 74}, {"CMPX", KOC_opcode, 3, 77}, {"CMPY", KOC_opcode, 3, 80},
   {"COM", KOC_opcode, 2, 83}, {"COMA", KOC_opcode, 1, 85}, {"COMB", KOC_opcode, 1, 86}, {"CWAI", KOC_opcode, 1, 87},
   {"DAA", KOC_opcode, 1, 88}, {"DB", KOC_BDEF, 0, 0}, {"DEC", KOC_opcode, 2, 89}, {"DECA", KOC_opcode, 1, 91},
   {"DECB", KOC_opcode, 1, 92}, {"DW", KOC_WDEF, 0, 0}, {"ELSE", KOC_ELSE, 0, 0}, {"END", KOC_END, 0, 0},
   {"ENDI", KOC_ENDI, 0, 0}, {"EORA", KOC_opcode, 3, 93}, {"EORB", KOC_opcode, 3, 96}, {"EQU", KOC_EQU, 0, 0},
   {"EXG", KOC_tfrop, 1, 99}, {"FCB", KOC_BDEF, 0, 0}, {"FCC", KOC_SDEF, 0, 0}, {"FDB", KOC_WDEF, 0, 0},
   {"IF", KOC_IF, 0, 0}, {"INC", KOC_opcode, 2, 100}, {"INCA", KOC_opcode, 1, 102}, {"INCB", KOC_opcode, 1, 103},
   {"INCL", KOC_INCLUDE, 0, 0}, {"INCLUDE", KOC_INCLUDE, 0, 0}, {"JMP", KOC_opcode, 2, 104}, {"JSR", KOC_opcode, 2, 106},
   {"LBCC", KOC_opcode, 1, 108}, {"LBCS", KOC_opcode, 1, 109}, {"LBEQ", KOC_opcode, 1, 110}, {"LBGE", KOC_opcode, 1, 111},
   {"LBGT", KOC_opcode, 1, 112}, {"LBHI", KOC_opcode, 1, 113}, {"LBHS", KOC_opcode, 1, 114}, {"LBLE", KOC_opcode, 1, 115},
   {"LBLO", KOC_opcode, 1, 116}, {"LBLS", KOC_opcode, 1, 117}, {"LBLT", KOC_opcode, 1, 118}, {"LBMI", KOC_opcode, 1, 119},
   {"LBNE", KOC_opcode, 1, 120}, {"LBPL", KOC_opcode, 1, 121}, {"LBRA", KOC_opcode, 1, 122}, {"LBRN", KOC_opcode, 1, 123},
   {"LBSR", KOC_opcode, 1, 124}, {"LBVC", KOC_opcode, 1, 125}, {"LBVS", KOC_opcode, 1, 126}, {"LDA", KOC_opcode, 3, 127},
   {"LDB", KOC_opcode, 3, 130}, {"LDD", KOC_opcode, 3, 133}, {"LDS", KOC_opcode, 3, 136}, {"LDU", KOC_opcode, 3, 139},
   {"LDX", KOC_opcode, 3, 142}, {"LDY", KOC_opcode, 3, 145}, {"LEAS", KOC_opcode, 1, 148}, {"LEAU", KOC_opcode, 1, 149},
   {"LEAX", KOC_opcode, 1, 150}, {"LEAY", KOC_opcode, 1, 151}, {"LSL", KOC_opcode, 2, 152}, {"LSLA", KOC_opcode, 1, 154},
   {"LSLB", KOC_opcode, 1, 155}, {"LSR", KOC_opcode, 2, 156}, {"LSRA", KOC_opcode, 1, 158}, {"LSRB", KOC_opcode, 1, 159},
   {"MUL", KOC_opcode, 1, 160}, {"NEG", KOC_opcode, 2, 161}, {"NEGA", KOC_opcode, 1, 163}, {"NEGB", KOC_opcode, 1, 164},
   {"NOP", KOC_opcode, 1, 165}, {"ORA", KOC_opcode, 3, 166}, {"ORB", KOC_opcode, 3, 169}, {"ORCC", KOC_opcode, 1, 172},
   {"ORG", KOC_ORG, 0, 0}, {"PSHS", KOC_sstkop, 1, 173}, {"PSHU", KOC_ustkop, 1, 174}, {"PULS", KOC_sstkop, 1, 175},
   {"PULU", KOC_ustkop, 1, 176}, {"RESERVE", KOC_RESM, 0, 0}, {"RMB", KOC_RESM, 0, 0}, {"ROL", KOC_opcode, 2, 177},
   {"ROLA", KOC_opcode, 1, 179}, {"ROLB", KOC_opcode, 1, 180}, {"ROR", KOC_opcode, 2, 181}, {"RORA", KOC_opcode, 1, 183},
   {"RORB", KOC_opcode, 1, 184}, {"RTI", KOC_opcode, 1, 185}, {"RTS", KOC_opcode, 1, 186}, {"SBCA", KOC_opcode, 3, 187},
   {"SBCB", KOC_opcode, 3, 190}, {"SET", KOC_SET, 0, 0}, {"SEX", KOC_opcode, 1, 193}, {"STA", KOC_opcode, 2, 194},
   {"STB", KOC_opcode, 2, 196}, {"STD", KOC_opcode, 2, 198}, {"STRING", KOC_SDEF, 0, 0}, {"STS", KOC_opcode, 2, 200},
   {"STU", KOC_opcode, 2, 202}, {"STX", KOC_opcode, 2, 204}, {"STY", KOC_opcode, 2, 206}, {"SUBA", KOC_opcode, 3, 208},
   {"SUBB", KOC_opcode, 3, 211}, {"SUBD", KOC_opcode, 3, 214}, {"SWI2", KOC_opcode, 1, 217}, {"SWI3", KOC_opcode, 1, 218},
   {"SWI", KOC_opcode, 1, 219}, {"SYNC", KOC_opcode, 1, 220}, {"TFR", KOC_tfrop, 1, 221}, {"TST", KOC_opcode, 2, 222},
   {"TSTA", KOC_opcode, 1, 224}, {"TSTB", KOC_opcode, 1, 225}, {"WORD", KOC_WDEF, 0, 0},
   {"", 0, 0, 0}
};
...
/* ABX 2 */ {0, 0, "3a;"},
/* ADCA 3 */ {ADDR, DIRECT, "99;[1=];"},
/* ADCA 4 */ {ADDR, EXTENDED, "b9;[1=]x"},
/* ADCA 5 */ {0, 0, "89;[1=];"},
/* ADCA 6 */ {0, 0, "a9;"},
/* ADCB 7 */ {ADDR, DIRECT, "d9;[1=];"},
/* ADCB 8 */ {ADDR, EXTENDED, "f9;[1=]x"},
/* ADCB 9 */ {0, 0, "c9;[1=];"},
/* ADCB 10 */ {0, 0, "e9;"},
/* ADDA 11 */ {ADDR, DIRECT, "9b;[1=];"},
/* ADDA 12 */ {ADDR, EXTENDED, "bb;[1=]x"},
/* ADDA 13 */ {0, 0, "8b;[1=];"},
/* ADDA 14 */ {0, 0, "ab;"},
/* ADDB 15 */ {ADDR, DIRECT, "db;[1=];"},
/* ADDB 16 */ {ADDR, EXTENDED, "fb;[1=]x"},
/* ADDB 17 */ {0, 0, "cb;[1=];"},
/* ADDB 18 */ {0, 0, "eb;"},
/* ADDD 19 */ {ADDR, DIRECT, "d3;[1=];"},
/* ADDD 20 */ {ADDR, EXTENDED, "f3;[1=]x"},
/* ADDD 21 */ {0, 0, "c3;[1=]x"},
/* ADDD 22 */ {0, 0, "e3;"},
/* ANDA 23 */ {ADDR, DIRECT, "94;[1=];"},
/* ANDA 24 */ {ADDR, EXTENDED, "b4;[1=]x"},
/* ANDA 25 */ {0, 0, "84;[1=];"},
/* ANDA 26 */ {0, 0, "a4;"},
/* ANDB 27 */ {ADDR, DIRECT, "d4;[1=];"},
/* ANDB 28 */ {ADDR, EXTENDED, "f4;[1=]x"},
/* ANDB 29 */ {0, 0, "c4;[1=];"},
/* ANDB 30 */ {0, 0, "e4;"},
/* ANDCC 31 */ {0, 0, "1c;[1=];"},
/* ASL 32 */ {ADDR, DIRECT, "08;[1=];"},
/* ASL 33 */ {ADDR, EXTENDED, "78;[1=]x"},
/* ASL 34 */ {0, 0, "68;"},
/* ASLA 35 */ {0, 0, "48;"},
/* ASLB 36 */ {0, 0, "58;"},
/* ASR 37 */ {ADDR, DIRECT, "07;[1=];"},
/* ASR 38 */ {ADDR, EXTENDED, "77;[1=]x"},
/* ASR 39 */ {0, 0, "67;"},
/* ASRA 40 */ {0, 0, "47;"},
/* ASRB 41 */ {0, 0, "57;"},
/* BCC 42 */ {0, 0, "24;[1=].Q.1+-r"},
/* BCS 43 */ {0, 0, "25;[1=].Q.1+-r"},
/* BEQ 44 */ {0, 0, "27;[1=].Q.1+-r"},
/* BGE 45 */ {0, 0, "2c;[1=].Q.1+-r"},
/* BGT 46 */ {0, 0, "2e;[1=].Q.1+-r"},
/* BHI 47 */ {0, 0, "22;[1=].Q.1+-r"},
/* BHS 48 */ {0, 0, "24;[1=].Q.1+-r"},
/* BITA 49 */ {ADDR, DIRECT, "95;[1=];"},
/* BITA 50 */ {ADDR, EXTENDED, "b5;[1=]x"},
/* BITA 51 */ {0, 0, "85;[1=];"},
/* BITA 52 */ {0, 0, "a5;"},
/* BITB 53 */ {ADDR, DIRECT, "d5;[1=];"},
/* BITB 54 */ {ADDR, EXTENDED, "f5;[1=]x"},
/* BITB 55 */ {0, 0, "c5;[1=];"},
/* BITB 56 */ {0, 0, "e5;"},
/* BLE 57 */ {0, 0, "2f;[1=].Q.1+-r"},
/* BLO 58 */ {0, 0, "25;[1=].Q.1+-r"},
/* BLS 59 */ {0, 0, "23;[1=].Q.1+-r"},
/* BLT 60 */ {0, 0, "2d;[1=].Q.1+-r"},
/* BMI 61 */ {0, 0, "2b;[1=].Q.1+-r"},
/* BNE 62 */ {0, 0, "26;[1=].Q.1+-r"},
/* BPL 63 */ {0, 0, "2a;[1=].Q.1+-r"},
/* BRA 64 */ {0, 0, "20;[1=].Q.1+-r"},
/* BRN 65 */ {0, 0, "21;[1=].Q.1+-r"},
/* BSR 66 */ {0, 0, "8d;[1=].Q.1+-r"},
/* BVC 67 */ {0, 0, "28;[1=].Q.1+-r"},
/* BVS 68 */ {0, 0, "29;[1=].Q.1+-r"},
/* CLR 69 */ {ADDR, DIRECT, "0f;[1=];"},
/* CLR 70 */ {ADDR, EXTENDED, "7f;[1=]x"},
/* CLR 71 */ {0, 0, "6f;"},
/* CLRA 72 */ {0, 0, "4f;"},
/* CLRB 73 */ {0, 0, "5f;"},
/* CMPA 74 */ {ADDR, DIRECT, "91;[1=];"},
/* CMPA 75 */ {ADDR, EXTENDED, "b1;[1=]x"},
/* CMPA 76 */ {0, 0, "81;[1=];"},
/* CMPA 77 */ {0, 0, "a1;"},
/* CMPB 78 */ {ADDR, DIRECT, "d1;[1=];"},
/* CMPB 79 */ {ADDR, EXTENDED, "f1;[1=]x"},
/* CMPB 80 */ {0, 0, "c1;[1=];"},
/* CMPB 81 */ {0, 0, "e1;"},
/* CMPD 82 */ {ADDR, DIRECT, "10;93;[1=];"},
/* CMPD 83 */ {ADDR, EXTENDED, "10;b3;[1=]x"},
/* CMPD 84 */ {0, 0, "10;83;[1=]x"},
/* CMPD 85 */ {0, 0, "10;a3;"},
/* CMPS 86 */ {ADDR, DIRECT, "11;9c;[1=];"},
/* CMPS 87 */ {ADDR, EXTENDED, "11;bc;[1=]x"},
/* CMPS 88 */ {0, 0, "11;8c;[1=]x"},
/* CMPS 89 */ {0, 0, "11;ac;"},
/* CMPU 90 */ {ADDR, DIRECT, "11;93;[1=];"},
/* CMPU 91 */ {ADDR, EXTENDED, "11;b3;[1=]x"},
/* CMPU 92 */ {0, 0, "11;83;[1=]x"},
/* CMPU 93 */ {0, 0, "11;a3;"},
/* CMPX 94 */ {ADDR, DIRECT, "9c;[1=];"},
/* CMPX 95 */ {ADDR, EXTENDED, "bc;[1=]x"},
/* CMPX 96 */ {0, 0, "8c;[1=]x"},
/* CMPX 97 */ {0, 0, "ac;"},
/* CMPY 98 */ {ADDR, DIRECT, "10;9c;[1=];"},
/* CMPY 99 */ {ADDR, EXTENDED, "10;bc;[1=]x"},
/* CMPY 100 */ {0, 0, "10;8c;[1=]x"},
/* CMPY 101 */ {0, 0, "10;ac;"},
/* COM 102 */ {ADDR, DIRECT, "03;[1=];"},
/* COM 103 */ {ADDR, EXTENDED, "73;[1=]x"},
/* COM 104 */ {0, 0, "63;"},
/* COMA 105 */ {0, 0, "43;"},
/* COMB 106 */ {0, 0, "53;"},
/* CWAI 107 */ {0, 0, "3c;[1=];"},
/* DAA 108 */ {0, 0, "19;"},
/* DEC 109 */ {ADDR, DIRECT, "0a;[1=];"},
/* DEC 110 */ {ADDR, EXTENDED, "7a;[1=]x"},
/* DEC 111 */ {0, 0, "6a;"},
/* DECA 112 */ {0, 0, "4a;"},
/* DECB 113 */ {0, 0, "5a;"},
/* EORA 114 */ {ADDR, DIRECT, "98;[1=];"},
/* EORA 115 */ {ADDR, EXTENDED, "b8;[1=]x"},
/* EORA 116 */ {0, 0, "88;[1=];"},
/* EORA 117 */ {0, 0, "a8;"},
/* EORB 118 */ {ADDR, DIRECT, "d8;[1=];"},
/* EORB 119 */ {ADDR, EXTENDED, "f8;[1=]x"},
/* EORB 120 */ {0, 0, "c8;[1=];"},
/* EORB 121 */ {0, 0, "e8;"},
/* EXG 122 */ {0, 0, "1e;[1#2#];"},
/* INC 123 */ {ADDR, DIRECT, "0c;[1=];"},
/* INC 124 */ {ADDR, EXTENDED, "7c;[1=]x"},
/* INC 125 */ {0, 0, "6c;"},
/* INCA 126 */ {0, 0, "4c;"},
/* INCB 127 */ {0, 0, "5c;"},
/* JMP 128 */ {ADDR, DIRECT, "0e;[1=];"},
/* JMP 129 */ {ADDR, EXTENDED, "7e;[1=]x"},
/* JMP 130 */ {0, 0, "6e;"},
/* JSR 131 */ {ADDR, DIRECT, "9d;[1=];"},
/* JSR 132 */ {ADDR, EXTENDED, "bd;[1=]x"},
/* JSR 133 */ {0, 0, "ad;"},
/* LBCC 134 */ {0, 0, "10;24;[1=].Q.2+-.ffff&x"},
/* LBCS 135 */ {0, 0, "10;25;[1=].Q.2+-.ffff&x"},
/* LBEQ 136 */ {0, 0, "10;27;[1=].Q.2+-.ffff&x"},
/* LBGE 137 */ {0, 0, "10;2c;[1=].Q.2+-.ffff&x"},
/* LBGT 138 */ {0, 0, "10;2e;[1=].Q.2+-.ffff&x"},
/* LBHI 139 */ {0, 0, "10;22;[1=].Q.2+-.ffff&x"},
/* LBHS 140 */ {0, 0, "10;24;[1=].Q.2+-.ffff&x"},
/* LBLE 141 */ {0, 0, "10;2f;[1=].Q.2+-.ffff&x"},
/* LBLO 142 */ {0, 0, "10;25;[1=].Q.2+-.ffff&x"},
/* LBLS 143 */ {0, 0, "10;23;[1=].Q.2+-.ffff&x"},
/* LBLT 144 */ {0, 0, "10;2d;[1=].Q.2+-.ffff&x"},
/* LBMI 145 */ {0, 0, "10;2b;[1=].Q.2+-.ffff&x"},
/* LBNE 146 */ {0, 0, "10;26;[1=].Q.2+-.ffff&x"},
/* LBPL 147 */ {0, 0, "10;2a;[1=].Q.2+-.ffff&x"},
/* LBRA 148 */ {0, 0, "16;[1=].Q.2+-.ffff&x"},
/* LBRN 149 */ {0, 0, "10;21;[1=].Q.2+-.ffff&x"},
/* LBSR 150 */ {0, 0, "17;[1=].Q.2+-.ffff&x"},
/* LBVC 151 */ {0, 0, "10;28;[1=].Q.2+-.ffff&x"},
/* LBVS 152 */ {0, 0, "10;29;[1=].Q.2+-.ffff&x"},
/* LDA 153 */ {ADDR, DIRECT, "96;[1=];"},
/* LDA 154 */ {ADDR, EXTENDED, "b6;[1=]x"},
/* LDA 155 */ {0, 0, "86;[1=];"},
/* LDA 156 */ {0, 0, "a6;"},
/* LDB 157 */ {ADDR, DIRECT, "d6;[1=];"},
/* LDB 158 */ {ADDR, EXTENDED, "f6;[1=]x"},
/* LDB 159 */ {0, 0, "c6;[1=];"},
/* LDB 160 */ {0, 0, "e6;"},
/* LDD 161 */ {ADDR, DIRECT, "dc;[1=];"},
/* LDD 162 */ {ADDR, EXTENDED, "fc;[1=]x"},
/* LDD 163 */ {0, 0, "cc;[1=]x"},
/* LDD 164 */ {0, 0, "ec;"},
/* LDS 165 */ {ADDR, DIRECT, "10;de;[1=];"},
/* LDS 166 */ {ADDR, EXTENDED, "10;fe;[1=]x"},
/* LDS 167 */ {0, 0, "10;ce;[1=]x"},
/* LDS 168 */ {0, 0, "10;ee;"},
/* LDU 169 */ {ADDR, DIRECT, "de;[1=];"},
/* LDU 170 */ {ADDR, EXTENDED, "fe;[1=]x"},
/* LDU 171 */ {0, 0, "ce;[1=]x"},
/* LDU 172 */ {0, 0, "ee;"},
/* LDX 173 */ {ADDR, DIRECT, "9e;[1=];"},
/* LDX 174 */ {ADDR, EXTENDED, "be;[1=]x"},
/* LDX 175 */ {0, 0, "8e;[1=]x"},
/* LDX 176 */ {0, 0, "ae;"},
/* LDY 177 */ {ADDR, DIRECT, "10;9e;[1=];"},
/* LDY 178 */ {ADDR, EXTENDED, "10;be;[1=]x"},
/* LDY 179 */ {0, 0, "10;8e;[1=]x"},
/* LDY 180 */ {0, 0, "10;ae;"},
/* LEAS 181 */ {0, 0, "32;"},
/* LEAU 182 */ {0, 0, "33;"},
/* LEAX 183 */ {0, 0, "30;"},
/* LEAY 184 */ {0, 0, "31;"},
/* LSL 185 */ {ADDR, DIRECT, "08;[1=];"},
/* LSL 186 */ {ADDR, EXTENDED, "78;[1=]x"},
/* LSL 187 */ {0, 0, "68;"},
/* LSLA 188 */ {0, 0, "48;"},
/* LSLB 189 */ {0, 0, "58;"},
/* LSR 190 */ {ADDR, DIRECT, "04;[1=];"},
/* LSR 191 */ {ADDR, EXTENDED, "74;[1=]x"},
/* LSR 192 */ {0, 0, "64;"},
/* LSRA 193 */ {0, 0, "44;"},
/* LSRB 194 */ {0, 0, "54;"},
/* MUL 195 */ {0, 0, "3d;"},
/* NEG 196 */ {ADDR, DIRECT, "00;[1=];"},
/* NEG 197 */ {ADDR, EXTENDED, "70;[1=]x"},
/* NEG 198 */ {0, 0, "60;"},
/* NEGA 199 */ {0, 0, "40;"},
/* NEGB 200 */ {0, 0, "50;"},
/* NOP 201 */ {0, 0, "12;"},
/* ORA 202 */ {ADDR, DIRECT, "9a;[1=];"},
/* ORA 203 */ {ADDR, EXTENDED, "ba;[1=]x"},
/* ORA 204 */ {0, 0, "8a;[1=];"},
/* ORA 205 */ {0, 0, "aa;"},
/* ORB 206 */ {ADDR, DIRECT, "da;[1=];"},
/* ORB 207 */ {ADDR, EXTENDED, "fa;[1=]x"},
/* ORB 208 */ {0, 0, "ca;[1=];"},
/* ORB 209 */ {0, 0, "ea;"},
/* ORCC 210 */ {0, 0, "1a;[1=];"},
/* PSHS 211 */ {0, 0, "34;[1#];"},
...
/* PULS 213 */ {0, 0, "35;[1#];"},
/* PULU 214 */ {0, 0, "37;[1#];"},
/* ROL 215 */ {ADDR, DIRECT, "09;[1=];"},
/* ROL 216 */ {ADDR, EXTENDED, "79;[1=]x"},
/* ROL 217 */ {0, 0, "69;"},
/* ROLA 218 */ {0, 0, "49;"},
/* ROLB 219 */ {0, 0, "59;"},
/* ROR 220 */ {ADDR, DIRECT, "06;[1=];"},
/* ROR 221 */ {ADDR, EXTENDED, "76;[1=]x"},
/* ROR 222 */ {0, 0, "66;"},
/* RORA 223 */ {0, 0, "46;"},
/* RORB 224 */ {0, 0, "56;"},
/* RTI 225 */ {0, 0, "3b;"},
/* RTS 226 */ {0, 0, "39;"},
/* SBCA 227 */ {ADDR, DIRECT, "92;[1=];"},
/* SBCA 228 */ {ADDR, EXTENDED, "b2;[1=]x"},
/* SBCA 229 */ {0, 0, "82;[1=];"},
/* SBCA 230 */ {0, 0, "a2;"},
/* SBCB 231 */ {ADDR, DIRECT, "d2;[1=];"},
/* SBCB 232 */ {ADDR, EXTENDED, "f2;[1=]x"},
/* SBCB 233 */ {0, 0, "c2;[1=];"},
/* SBCB 234 */ {0, 0, "e2;"},
/* SEX 235 */ {0, 0, "1d;"},
/* STA 236 */ {ADDR, DIRECT, "97;[1=];"},
/* STA 237 */ {ADDR, EXTENDED, "b7;[1=]x"},
/* STA 238 */ {0, 0, "a7;"},
/* STB 239 */ {ADDR, DIRECT, "d7;[1=];"},
/* STB 240 */ {ADDR, EXTENDED, "f7;[1=]x"},
/* STB 241 */ {0, 0, "e7;"},
/* STD 242 */ {ADDR, DIRECT, "dd;[1=];"},
/* STD 243 */ {ADDR, EXTENDED, "fd;[1=]x"},
/* STD 244 */ {0, 0, "ed;"},
/* STS 245 */ {ADDR, DIRECT, "10;df;[1=];"},
/* STS 246 */ {ADDR, EXTENDED, "10;ff;[1=]x"},
/* STS 247 */ {0, 0, "10;ef;"},
/* STU 248 */ {ADDR, DIRECT, "df;[1=];"},
/* STU 249 */ {ADDR, EXTENDED, "ff;[1=]x"},
/* STU 250 */ {0, 0, "ef;"},
/* STX 251 */ {ADDR, DIRECT, "9f;[1=];"},
/* STX 252 */ {ADDR, EXTENDED, "bf;[1=]x"},
/* STX 253 */ {0, 0, "af;"},
/* STY 254 */ {ADDR, DIRECT, "10;9f;[1=];"},
/* STY 255 */ {ADDR, EXTENDED, "10;bf;[1=]x"},
/* STY 256 */ {0, 0, "10;af;"},
/* SUBA 257 */ {ADDR, DIRECT, "90;[1=];"},
/* SUBA 258 */ {ADDR, EXTENDED, "b0;[1=]x"},
/* SUBA 259 */ {0, 0, "80;[1=];"},
/* SUBA 260 */ {0, 0, "a0;"},
/* SUBB 261 */ {ADDR, DIRECT, "d0;[1=];"},
/* SUBB 262 */ {ADDR, EXTENDED, "f0;[1=]x"},
/* SUBB 263 */ {0, 0, "c0;[1=];"},
/* SUBB 264 */ {0, 0, "e0;"},
/* SUBD 265 */ {ADDR, DIRECT, "93;[1=];"},
/* SUBD 266 */ {ADDR, EXTENDED, "b3;[1=]x"},
/* SUBD 267 */ {0, 0, "83;[1=]x"},
/* SUBD 268 */ {0, 0, "a3;"},
/* SWI2 269 */ {0, 0, "10;3f;"},
/* SWI3 270 */ {0, 0, "11;3f;"},
...
/* SYNC 272 */ {0, 0, "13;"},
/* TFR 273 */ {0, 0, "1f;[1#2#];"},
/* TST 274 */ {ADDR, DIRECT, "0d;[1=];"},
/* TST 275 */ {ADDR, EXTENDED, "7d;[1=]x"},
/* TST 276 */ {0, 0, "6d;"},
/* TSTA 277 */ {0, 0, "4d;"},
/* TSTB 278 */ {0, 0, "5d;"},
   {0, 0, ""}
