...
line: KOC_CPU STRING {
   if (!cpumatch($2)) fraerror("unknown cpu type, Z8 assumed"), cpuselect = CPU8600;
};
...
genline: KOC_srp '#' expr {
   ...
   if (evalr[1].seg != SSG_ABS)
      ...
      case 0x00: case 0x10: case 0x20: case 0x30: case 0x40: case 0x50: case 0x60: case 0x70: case 0xf0:
         genlocrec(currseg, labelloc);
         locctr += geninstr(findgen($1, ST_IMM, 0));
      break;
      default: fraerror("invalid value for SRP"); break;
   }
};
...
expr: '(' expr ')' { $$ = $2; };
expr: '(' REGISTER ')' { $$ = exprnode(PCCASE_CONS, 0, 'V', 0, (long)(REGBITS&$2), NULL); };
%%
...
bool cpumatch(char *str) {
   static struct {
      ...
      {"86", CPU8600}, {"z8", CPU8600}, {"Z8", CPU8600}, {"upc", CPU8090},
      {"UPC", CPU8090}, {"9", CPU8090}
   };
...
struct opsym optab[] = {
   {"invalid", KOC_opcode, 2, 0}, {"ADC", KOC_opcode, 4, 2}, {"ADD", KOC_opcode, 4, 6}, {"AND", KOC_opcode, 4, 10},
   {"BYTE", KOC_BDEF, 0, 0}, {"CALL", KOC_opcode, 2, 14}, {"CCF", KOC_opcode, 1, 16}, {"CHARDEF", KOC_CHDEF, 0, 0},
   {"CHARSET", KOC_CHSET, 0, 0}, {"CHARUSE", KOC_CHUSE, 0, 0}, {"CHD", KOC_CHDEF, 0, 0}, {"CLR", KOC_opcode, 2, 17},
   {"COM", KOC_opcode, 2, 19}, {"CP", KOC_opcode, 4, 21}, {"CPU", KOC_CPU, 0, 0}, {"DA", KOC_opcode, 2, 25},
   {"DB", KOC_BDEF, 0, 0}, {"DEC", KOC_opcode, 2, 27}, {"DECW", KOC_opcode, 2, 29}, {"DI", KOC_opcode, 1, 31},
   {"DJNZ", KOC_opcode, 1, 32}, {"DW", KOC_WDEF, 0, 0}, {"EI", KOC_opcode, 1, 33}, {"ELSE", KOC_ELSE, 0, 0},
   {"END", KOC_END, 0, 0}, {"ENDI", KOC_ENDI, 0, 0}, {"EQU", KOC_EQU, 0, 0}, {"FCB", KOC_BDEF, 0, 0},
   {"FCC", KOC_SDEF, 0, 0}, {"FDB", KOC_WDEF, 0, 0}, {"IF", KOC_IF, 0, 0}, {"INC", KOC_opcode, 2, 34},
   {"INCL", KOC_INCLUDE, 0, 0}, {"INCLUDE", KOC_INCLUDE, 0, 0}, {"INCW", KOC_opcode, 2, 36}, {"IRET", KOC_opcode, 1, 38},
   {"JP", KOC_opcode, 3, 39}, {"JR", KOC_opcode, 2, 42}, {"LD", KOC_opcode, 7, 44}, {"LDC", KOC_opcode, 2, 51},
   {"LDCI", KOC_opcode, 1, 53}, {"LDE", KOC_opcode, 2, 54}, {"LDEI", KOC_opcode, 1, 56}, {"NOP", KOC_opcode, 1, 57},
   {"OR", KOC_opcode, 4, 58}, {"ORG", KOC_ORG, 0, 0}, {"POP", KOC_opcode, 2, 62}, {"PUSH", KOC_opcode, 2, 64},
   {"RCF", KOC_opcode, 1, 66}, {"REG", KOC_REG, 0, 0}, {"RESERVE", KOC_RESM, 0, 0}, {"RET", KOC_opcode, 1, 67},
   {"RL", KOC_opcode, 2, 68}, {"RLC", KOC_opcode, 2, 70}, {"RMB", KOC_RESM, 0, 0}, {"RR", KOC_opcode, 2, 72},
   {"RRC", KOC_opcode, 2, 74}, {"RREG", KOC_RREG, 0, 0}, {"SBC", KOC_opcode, 4, 76}, {"SCF", KOC_opcode, 1, 80},
   {"SET", KOC_SET, 0, 0}, {"SRA", KOC_opcode, 2, 81}, {"SRP", KOC_srp, 1, 83}, {"STRING", KOC_SDEF, 0, 0},
   {"SUB", KOC_opcode, 4, 84}, {"SWAP", KOC_opcode, 2, 88}, {"TCM", KOC_opcode, 4, 90}, {"TM", KOC_opcode, 4, 94},
   {"WORD", KOC_WDEF, 0, 0}, {"XOR", KOC_opcode, 4, 98},
   {"", 0, 0, 0}
};
...
/* ADC 2 */ {0, 0, "17;[1#];[2=];"},
/* ADC 3 */ {SRCWORK + DSTWORK, SRCWORK + DSTWORK, "12;[2#4#];"},
/* ADC 4 */ {0, 0, "14;[3#];[1#];"},
/* ADC 5 */ {0, 0, "16;[1#];[2=];"},
/* ADC 6 */ {SRCWORK + DSTWORK, SRCWORK + DSTWORK, "13;[2#4#];"},
/* ADC 7 */ {0, 0, "15;[3#];[1#];"},
/* ADD 8 */ {0, 0, "07;[1#];[2=];"},
/* ADD 9 */ {SRCWORK + DSTWORK, SRCWORK + DSTWORK, "02;[2#4#];"},
/* ADD 10 */ {0, 0, "04;[3#];[1#];"},
/* ADD 11 */ {0, 0, "06;[1#];[2=];"},
/* ADD 12 */ {SRCWORK + DSTWORK, SRCWORK + DSTWORK, "03;[2#4#];"},
/* ADD 13 */ {0, 0, "05;[3#];[1#];"},
/* AND 14 */ {0, 0, "57;[1#];[2=];"},
/* AND 15 */ {SRCWORK + DSTWORK, SRCWORK + DSTWORK, "52;[2#4#];"},
/* AND 16 */ {0, 0, "54;[3#];[1#];"},
/* AND 17 */ {0, 0, "56;[1#];[2=];"},
/* AND 18 */ {SRCWORK + DSTWORK, SRCWORK + DSTWORK, "53;[2#4#];"},
/* AND 19 */ {0, 0, "55;[3#];[1#];"},
/* CALL 20 */ {0, 0, "d6;[1=]x"},
/* CALL 21 */ {DSTDBL, DSTDBL, "d4;[1#];"},
/* CCF 22 */ {0, 0, "ef;"},
/* CLR 23 */ {0, 0, "b1;[1#];"},
/* CLR 24 */ {0, 0, "b0;[1#];"},
/* COM 25 */ {0, 0, "61;[1#];"},
/* COM 26 */ {0, 0, "60;[1#];"},
/* CP 27 */ {0, 0, "a7;[1#];[2=];"},
/* CP 28 */ {SRCWORK + DSTWORK, SRCWORK + DSTWORK, "a2;[2#4#];"},
/* CP 29 */ {0, 0, "a4;[3#];[1#];"},
/* CP 30 */ {0, 0, "a6;[1#];[2=];"},
/* CP 31 */ {SRCWORK + DSTWORK, SRCWORK + DSTWORK, "a3;[2#4#];"},
/* CP 32 */ {0, 0, "a5;[3#];[1#];"},
/* DA 33 */ {0, 0, "41;[1#];"},
/* DA 34 */ {0, 0, "40;[1#];"},
/* DEC 35 */ {0, 0, "01;[1#];"},
/* DEC 36 */ {0, 0, "00;[1#];"},
/* DECW 37 */ {0, 0, "81;[1#];"},
/* DECW 38 */ {DSTDBL, DSTDBL, "80;[1#];"},
/* DI 39 */ {0, 0, "8f;"},
/* DJNZ 40 */ {DSTWORK, DSTWORK, "[3#]a;[2=].Q.1+-r"},
/* EI 41 */ {0, 0, "9f;"},
/* INC 42 */ {0, 0, "21;[1#];"},
/* INC 43 */ {DSTWORK, DSTWORK, "[2#]e;"},
/* INC 44 */ {0, 0, "20;[1#];"},
/* INCW 45 */ {0, 0, "a1;[1#];"},
/* INCW 46 */ {DSTDBL, DSTDBL, "a0;[1#];"},
/* IRET 47 */ {0, 0, "bf;"},
/* JP 48 */ {0, 0, "[1#]d;[2=]x"},
/* JP 49 */ {0, 0, "8d;[1=]x"},
/* JP 50 */ {DSTDBL, DSTDBL, "30;[1#];"},
/* JR 51 */ {0, 0, "[1#]b;[2=].Q.1+-r"},
/* JR 52 */ {0, 0, "8b;[1=].Q.1+-r"},
/* LD 53 */ {0, 0, "e7;[1#];[2=];"},
/* LD 54 */ {DSTWORK + SRCWORK, DSTWORK + SRCWORK, "f3;[2#4#];"},
/* LD 55 */ {0, 0, "f5;[3#];[1#];"},
/* LD 56 */ {DSTWORK, DSTWORK, "[2#]8;[3#];"},
/* LD 57 */ {SRCWORK, SRCWORK, "[4#]9;[1#];"},
/* LD 58 */ {0, 0, "e4;[3#];[1#];"},
/* LD 59 */ {DSTWORK, DSTWORK, "[3#]c;[2=];"},
/* LD 60 */ {0, 0, "e6;[1#];[2=];"},
/* LD 61 */ {DSTWORK + SRCWORK, DSTWORK + SRCWORK, "e3;[2#4#];"},
/* LD 62 */ {0, 0, "e5;[3#];[1#];"},
/* LD 63 */ {DSTWORK + SRCWORK, DSTWORK + SRCWORK, "c7;[1#3#];[2=];"},
/* LD 64 */ {DSTWORK + SRCWORK, DSTWORK + SRCWORK, "d7;[3#2#];[1=];"},
/* LDC 65 */ {DSTWORK + SRCWORK, DSTWORK + SRCWORK, "d2;[4#2#];"},
/* LDC 66 */ {DSTWORK + SRCWORK, DSTWORK + SRCWORK, "c2;[2#4#];"},
/* LDCI 67 */ {SRCDBL + DSTDBL + DSTWORK + SRCWORK, SRCDBL + DSTWORK + SRCWORK, "c3;[2#4#];"},
/* LDCI 68 */ {SRCDBL + DSTDBL + DSTWORK + SRCWORK, DSTDBL + DSTWORK + SRCWORK, "d3;[4#2#];"},
/* LDE 69 */ {DSTWORK + SRCWORK, DSTWORK + SRCWORK, "92;[4#2#];"},
/* LDE 70 */ {DSTWORK + SRCWORK, DSTWORK + SRCWORK, "82;[2#4#];"},
/* LDEI 71 */ {SRCDBL + DSTDBL + DSTWORK + SRCWORK, SRCDBL + DSTWORK + SRCWORK, "83;[2#4#];"},
/* LDEI 72 */ {SRCDBL + DSTDBL + DSTWORK + SRCWORK, DSTDBL + DSTWORK + SRCWORK, "93;[4#2#];"},
/* NOP 73 */ {0, 0, "ff;"},
/* OR 74 */ {0, 0, "47;[1#];[2=];"},
/* OR 75 */ {SRCWORK + DSTWORK, SRCWORK + DSTWORK, "42;[2#4#];"},
/* OR 76 */ {0, 0, "44;[3#];[1#];"},
/* OR 77 */ {0, 0, "46;[1#];[2=];"},
/* OR 78 */ {SRCWORK + DSTWORK, SRCWORK + DSTWORK, "43;[2#4#];"},
/* OR 79 */ {0, 0, "45;[3#];[1#];"},
/* POP 80 */ {0, 0, "51;[1#];"},
/* POP 81 */ {0, 0, "50;[1#];"},
/* PUSH 82 */ {0, 0, "71;[1#];"},
...
/* RRC 93 */ {0, 0, "c0;[1#];"},
/* SBC 94 */ {0, 0, "37;[1#];[2=];"},
/* SBC 95 */ {SRCWORK + DSTWORK, SRCWORK + DSTWORK, "32;[2#4#];"},
/* SBC 96 */ {0, 0, "34;[3#];[1#];"},
/* SBC 97 */ {0, 0, "36;[1#];[2=];"},
/* SBC 98 */ {SRCWORK + DSTWORK, SRCWORK + DSTWORK, "33;[2#4#];"},
/* SBC 99 */ {0, 0, "35;[3#];[1#];"},
/* SCF 100 */ {0, 0, "df;"},
/* SRA 101 */ {0, 0, "d1;[1#];"},
/* SRA 102 */ {0, 0, "d0;[1#];"},
/* SRP 103 */ {0, 0, "31;[1=];"},
/* SUB 104 */ {0, 0, "27;[1#];[2=];"},
/* SUB 105 */ {SRCWORK + DSTWORK, SRCWORK + DSTWORK, "22;[2#4#];"},
/* SUB 106 */ {0, 0, "24;[3#];[1#];"},
/* SUB 107 */ {0, 0, "26;[1#];[2=];"},
/* SUB 108 */ {SRCWORK + DSTWORK, SRCWORK + DSTWORK, "23;[2#4#];"},
/* SUB 109 */ {0, 0, "25;[3#];[1#];"},
/* SWAP 110 */ {0, 0, "f1;[1#];"},
/* SWAP 111 */ {0, 0, "f0;[1#];"},
/* TCM 112 */ {0, 0, "67;[1#];[2=];"},
/* TCM 113 */ {SRCWORK + DSTWORK, SRCWORK + DSTWORK, "62;[2#4#];"},
/* TCM 114 */ {0, 0, "64;[3#];[1#];"},
/* TCM 115 */ {0, 0, "66;[1#];[2=];"},
/* TCM 116 */ {SRCWORK + DSTWORK, SRCWORK + DSTWORK, "63;[2#4#];"},
/* TCM 117 */ {0, 0, "65;[3#];[1#];"},
/* TM 118 */ {0, 0, "77;[1#];[2=];"},
/* TM 119 */ {SRCWORK + DSTWORK, SRCWORK + DSTWORK, "72;[2#4#];"},
/* TM 120 */ {0, 0, "74;[3#];[1#];"},
/* TM 121 */ {0, 0, "76;[1#];[2=];"},
/* TM 122 */ {SRCWORK + DSTWORK, SRCWORK + DSTWORK, "73;[2#4#];"},
/* TM 123 */ {0, 0, "75;[3#];[1#];"},
/* XOR 124 */ {0, 0, "b7;[1#];[2=];"},
/* XOR 125 */ {SRCWORK + DSTWORK, SRCWORK + DSTWORK, "b2;[2#4#];"},
/* XOR 126 */ {0, 0, "b4;[3#];[1#];"},
/* XOR 127 */ {0, 0, "b6;[1#];[2=];"},
/* XOR 128 */ {SRCWORK + DSTWORK, SRCWORK + DSTWORK, "b3;[2#4#];"},
/* XOR 129 */ {0, 0, "b5;[3#];[1#];"},
   {0, 0, ""}
};
