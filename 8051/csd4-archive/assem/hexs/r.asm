...
;; It should operate reliably with a host connected over a RS-232, RS-422, RS-423 or RS-485.
;; If using half-duplex, T0 is configured here as the Transmit-Enable control output.

;; This was originally written to be assembled by the Binary Technology 8051/8052 Cross Assembler (sxa51).
